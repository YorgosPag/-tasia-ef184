(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
      ...
      let o = (0, i.F)(
        ...
        d = a.forwardRef((e, t) => {
          let { className: r, variant: a, size: i, asChild: d = !1, ...c } = e,
            u = d ? n.DX : "button";
          return (0, s.jsx)(u, {
            className: (0, l.cn)(o({ variant: a, size: i, className: r })),
            ref: t,
            ...c,
          });
        });
      ...
      function j() {
        let e = (0, n.useRouter)(),
          ...
          N = async (r) => {
            o(!0);
            try {
              (await (0, d.x9)(c.j2, r.email, r.password), e.push("/"));
            } catch (r) {
              console.error("Authentication Error:", r);
              let e = "An unexpected error occurred. Please try again.";
              (("auth/invalid-credential" === r.code ||
                "auth/wrong-password" === r.code ||
                "auth/user-not-found" === r.code) &&
                (e = "Invalid email or password. Please try again."),
                t({
                  variant: "destructive",
                  title: "Login Failed",
                  description: e,
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    (e.O(0, [992, 644, 669, 313, 441, 684, 358], () => t(935)), (_N_E = e.O()));
  },
]);
