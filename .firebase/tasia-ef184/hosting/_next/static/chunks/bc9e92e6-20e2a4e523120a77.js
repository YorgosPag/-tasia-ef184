...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [992],
  {
    7015: (e, t, n) => {
      ...
      ((y.UNAUTHENTICATED = new y(null)),
        (y.GOOGLE_CREDENTIALS = new y("google-credentials-uid")),
        (y.FIRST_PARTY = new y("first-party-uid")),
        (y.MOCK_USER = new y("mock-user")));
      let w = "11.9.0",
        v = new u.Vy("@firebase/firestore");
      function I() {
        return v.logLevel;
      }
      function T(e, ...t) {
        if (v.logLevel <= u.$b.DEBUG) {
          let n = t.map(x);
          v.debug(`Firestore (${w}): ${e}`, ...n);
        }
      }
      function E(e, ...t) {
        if (v.logLevel <= u.$b.ERROR) {
          let n = t.map(x);
          v.error(`Firestore (${w}): ${e}`, ...n);
        }
      }
      function b(e, ...t) {
        if (v.logLevel <= u.$b.WARN) {
          let n = t.map(x);
          v.warn(`Firestore (${w}): ${e}`, ...n);
        }
      }
      function x(e) {
      ...
      function _(e, t, n) {
        ...
        ("string" == typeof t ? (r = t) : (n = t), S(e, r, n));
      }
      function S(e, t, n) {
        let r = `FIRESTORE (${w}) INTERNAL ASSERTION FAILED: ${t} (ID: ${e.toString(16)})`;
        if (void 0 !== n)
          try {
      ...
      function C(e, t, n, r) {
        ...
        ("string" == typeof n ? (i = n) : (r = n), e || S(t, i, r));
      }
      let N = {
        OK: "ok",
        CANCELLED: "cancelled",
      ...
      class V {
        ...
        invalidateToken() {}
        start(e, t) {
          e.enqueueRetryable(() => t(y.UNAUTHENTICATED));
        }
        shutdown() {}
      }
      class R {
      ...
      class O {
        constructor(e) {
          ((this.t = e),
            (this.currentUser = y.UNAUTHENTICATED),
            (this.i = 0),
            (this.forceRefresh = !1),
            (this.auth = null));
        }
        start(e, t) {
          C(void 0 === this.o, 42304);
          let n = this.i,
            r = (e) =>
          ...
          let s = () => {
            ...
            a = (e) => {
              (T("FirebaseAuthCredentialsProvider", "Auth detected"),
                (this.auth = e),
                  ...
                  .then((t) =>
                    this.i !== e
                      ? (T(
                        ...
                        this.getToken())
                      : t
                        ? (C("string" == typeof t.accessToken, 31837, { l: t }),
                          new A(t.accessToken, this.currentUser))
                        : null,
                  )
        ...
        u() {
          ...
          return (
            C(null === e || "string" == typeof e, 2055, { h: e }),
            new y(e)
          );
        }
      }
      ...
      class F {
        ...
        getToken() {
          return Promise.resolve(new M(this.P, this.T, this.I));
        }
        start(e, t) {
          e.enqueueRetryable(() => t(y.FIRST_PARTY));
        }
        shutdown() {}
        invalidateToken() {}
      }
      ...
      class P {
        ...
        start(e, t) {
          ...
          let r = (e) => {
            (T("FirebaseAppCheckTokenProvider", "AppCheck detected"),
              (this.appCheck = e),
        ...
        getToken() {
          if (this.p) return Promise.resolve(new L(this.p));
      ...
      function z(e, t) {
        ...
        for (; n < e.length && n < t.length; ) {
          let r = e.codePointAt(n),
            i = t.codePointAt(n);
          if (r !== i) {
            if (r < 128 && i < 128) return B(r, i);
            {
              let s = U(),
                a = (function (e, t) {
                  for (let n = 0; n < e.length && n < t.length; ++n)
                    if (e[n] !== t[n]) return B(e[n], t[n]);
                  return B(e.length, t.length);
                })(s.encode($(e, n)), s.encode($(t, n)));
              return 0 !== a ? a : B(r, i);
            }
          }
          n += r > 65535 ? 2 : 1;
      ...
      class G {
        ...
        static fromDate(e) {
          return G.fromMillis(e.getTime());
        }
        static fromMillis(e) {
          let t = Math.floor(e / 1e3),
            n = Math.floor((e - 1e3 * t) * 1e6);
          return new G(t, n);
        }
        constructor(e, t) {
      ...
      class j {
        ...
        static min() {
          return new j(new G(0, 0));
        }
        static max() {
          return new j(new G(0x3afff4417f, 0x3b9ac9ff));
        }
        constructor(e) {
          this.timestamp = e;
        }
      ...
      class Y {
        constructor(e, t, n) {
          (void 0 === t
            ? (t = 0)
            : t > e.length && _(637, { offset: t, range: e.length }),
            void 0 === n
              ? (n = e.length - t)
              : n > e.length - t && _(1746, { length: n, range: e.length - t }),
            (this.segments = e),
            (this.offset = t),
            (this.len = n));
        }
        ...
        static comparator(e, t) {
          ...
          for (let r = 0; r < n; r++) {
            let n = Y.compareSegments(e.get(r), t.get(r));
            if (0 !== n) return n;
          }
          return B(e.length, t.length);
        }
        static compareSegments(e, t) {
          let n = Y.isNumericId(e),
            r = Y.isNumericId(t);
          return n && !r
            ? -1
            : !n && r
              ? 1
              : n && r
                ? Y.extractNumericId(e).compare(Y.extractNumericId(t))
                : z(e, t);
        }
        ...
        static extractNumericId(e) {
          return c.jz.fromString(e.substring(4, e.length - 2));
        }
      }
      class H extends Y {
        construct(e, t, n) {
      ...
      class X extends Y {
        ...
        static fromServerFormat(e) {
          ...
          if ((i(), s))
            throw new D(N.INVALID_ARGUMENT, "Unterminated ` in path: " + e);
          return new X(t);
        }
        static emptyPath() {
          return new X([]);
      ...
      class J {
        ...
        static fromPath(e) {
          return new J(H.fromString(e));
        }
        static fromName(e) {
          return new J(H.fromString(e).popFirst(5));
        }
        static empty() {
          return new J(H.emptyPath());
        }
        get collectionGroup() {
        ...
        isEqual(e) {
          return null !== e && 0 === H.comparator(this.path, e.path);
        }
        toString() {
      ...
      function ei(e, t) {
        ...
        return new ea(
          j.fromTimestamp(1e9 === r ? new G(n + 1, 0) : new G(n, r)),
          J.empty(),
          t,
        );
      }
      function es(e) {
        return new ea(e.readTime, e.key, -1);
      }
      class ea {
        constructor(e, t, n) {
          ((this.readTime = e),
        ...
        static min() {
          return new ea(j.min(), J.empty(), -1);
        }
        static max() {
          return new ea(j.max(), J.empty(), -1);
        }
      }
      function eo(e, t) {
        let n = e.readTime.compareTo(t.readTime);
        return 0 !== n || 0 !== (n = J.comparator(e.documentKey, t.documentKey))
          ? n
          : B(e.largestBatchId, t.largestBatchId);
      }
      let el =
      ...
      async function eh(e) {
        if (e.code !== N.FAILED_PRECONDITION || e.message !== el) throw e;
      ...
      class ec {
        ...
        static or(e) {
          let t = ec.resolve(!1);
          for (let n of e) t = t.next((e) => (e ? ec.resolve(e) : n()));
          return t;
        }
        static forEach(e, t) {
          let n = [];
      ...
      class ef {
        static open(e, t, n, r) {
          try {
            return new ef(t, e.transaction(r, n));
          } catch (e) {
            throw new ey(t, e);
          }
        }
        constructor(e, t) {
          ((this.action = e),
            ...
            (this.transaction.onabort = () => {
              t.error ? this.S.reject(new ey(e, t.error)) : this.S.resolve();
            }),
            (this.transaction.onerror = (t) => {
              let n = eE(t.target.error);
              this.S.reject(new ey(e, n));
            }));
        }
        get D() {
        ...
        store(e) {
          return new ev(this.transaction.objectStore(e));
        }
      }
      class em {
        static delete(e) {
          return (
            T(ed, "Removing database:", e),
            eI((0, h.mS)().indexedDB.deleteDatabase(e)).toPromise()
          );
        }
        static C() {
          if (!(0, h.zW)()) return !1;
        ...
        static F() {
          ...
          return (
            void 0 !== f &&
            "YES" === (null == (e = f.__PRIVATE_env) ? void 0 : e.O)
          );
        }
        static N(e, t) {
          return e.store(t);
        ...
        async k(e) {
          return (
            this.db ||
              (T(ed, "Opening database:", this.name),
        ...
        async runTransaction(e, t, n, r) {
          ...
          for (;;) {
            ...
            try {
              ...
              let t = ef.open(this.db, e, i ? "readonly" : "readwrite", n),
                s = r(t)
                  .next((e) => (t.v(), e))
                  .catch((e) => (t.abort(e), ec.reject(e)))
                  .toPromise();
      ...
      class ev {
        ...
        put(e, t) {
          ...
          return (
            void 0 !== t
              ? (T(ed, "PUT", this.store.name, e, t),
                (n = this.store.put(t, e)))
              : (T(ed, "PUT", this.store.name, "<auto-key>", e),
                (n = this.store.put(e))),
            eI(n)
          );
        }
        add(e) {
          return (T(ed, "ADD", this.store.name, e, e), eI(this.store.add(e)));
        }
        get(e) {
          return eI(this.store.get(e)).next(
            (t) => (
              void 0 === t && (t = null),
              T(ed, "GET", this.store.name, e, t),
              t
            ),
          );
        }
        delete(e) {
          return (
            T(ed, "DELETE", this.store.name, e),
            eI(this.store.delete(e))
          );
        }
        count() {
          return (T(ed, "COUNT", this.store.name), eI(this.store.count()));
        }
        J(e, t) {
        ...
        X(e, t) {
          T(ed, "DELETE ALL", this.store.name);
          let n = this.options(e, t);
          n.ee = !1;
          let r = this.cursor(n);
          ...
          return new ec((r, i) => {
            ((e.onerror = (e) => {
              ...
              (e.onsuccess = (e) => {
                ...
                if (a instanceof ec) {
                  let e = a.catch((e) => (s.done(), ec.reject(e)));
                  n.push(e);
                }
      ...
      class eS {
        constructor(e, t) {
          ((this.previousValue = e),
            t &&
              ((t.sequenceNumberHandler = (e) => this.ue(e)),
      ...
      function eA(e) {
        let t = e.length;
        if ((C(t >= 2, 64408, { path: e }), 2 === t))
          return (
            C("\x01" === e.charAt(0) && "\x01" === e.charAt(1), 56145, {
              path: e,
            }),
            H.emptyPath()
          );
        ...
        for (let s = 0; s < t; ) {
          ...
          switch (
            ((t < 0 || t > n) && _(50515, { path: e }), e.charAt(t + 1))
          ) {
            case "\x01":
              let a,
                o = e.substring(s, t);
      ...
      let eV = "remoteDocuments",
        eR = "owner",
        eO = "owner",
        eM = "mutationQueues",
        eF = "mutations",
        eL = "batchId",
        eP = "userMutationsIndex",
        eU = ["userId", "batchId"],
        eq = {},
        eB = "documentMutations",
        ez = "remoteDocumentsV14",
        e$ = ["prefixPath", "collectionGroup", "readTime", "documentId"],
        eK = "documentKeyIndex",
        eG = ["prefixPath", "collectionGroup", "documentId"],
        ej = "collectionGroupIndex",
        eQ = ["collectionGroup", "readTime", "prefixPath", "documentId"],
        eY = "remoteDocumentGlobal",
        eH = "remoteDocumentGlobalKey",
        eW = "targets",
        eX = "queryTargetsIndex",
        eJ = ["canonicalId", "targetId"],
        eZ = "targetDocuments",
        e0 = ["targetId", "path"],
        e1 = "documentTargetsIndex",
        e2 = ["path", "targetId"],
        e5 = "targetGlobalKey",
        e4 = "targetGlobal",
        e3 = "collectionParents",
        e6 = ["collectionId", "parent"],
        e8 = "clientMetadata",
        e9 = "bundles",
        e7 = "namedQueries",
        te = "indexConfiguration",
        tt = "collectionGroupIndex",
        tn = "indexState",
        tr = ["indexId", "uid"],
        ti = "sequenceNumberIndex",
        ts = ["uid", "sequenceNumber"],
        ta = "indexEntries",
        to = [
          "indexId",
          "uid",
        ...
        tl = "documentKeyIndex",
        tu = ["indexId", "uid", "orderedDocumentKey"],
        th = "documentOverlays",
        tc = ["userId", "collectionPath", "documentId"],
        td = "collectionPathOverlayIndex",
        tf = ["userId", "collectionPath", "largestBatchId"],
        tm = "collectionGroupOverlayIndex",
        tg = ["userId", "collectionGroup", "largestBatchId"],
        tp = "globals",
        ty = [eM, eF, eB, eV, eW, eR, e4, eZ, e8, eY, e3, e9, e7],
        tw = [...ty, th],
        tv = [eM, eF, eB, ez, eW, eR, e4, eZ, e8, eY, e3, e9, e7, th],
        tI = [...tv, te, tn, ta],
        tT = [...tI, tp];
      class tE extends eu {
        constructor(e, t) {
      ...
      class tC {
        constructor(e, t) {
          ((this.comparator = e), (this.root = t || tD.EMPTY));
        }
        insert(e, t) {
          return new tC(
            this.comparator,
            this.root
              ...
              .copy(null, null, tD.BLACK, null, null),
          );
        }
        remove(e) {
          return new tC(
        ...
        getIteratorFrom(e) {
          return new tN(this.root, e, this.comparator, !1);
        }
        getReverseIterator() {
          return new tN(this.root, null, this.comparator, !0);
        }
        getReverseIteratorFrom(e) {
          return new tN(this.root, e, this.comparator, !0);
        }
      }
      class tN {
        constructor(e, t, n, r) {
      ...
      class tD {
        constructor(e, t, n, r, i) {
          ((this.key = e),
            (this.value = t),
            (this.color = null != n ? n : tD.RED),
            (this.left = null != r ? r : tD.EMPTY),
            (this.right = null != i ? i : tD.EMPTY),
        ...
        removeMin() {
          if (this.left.isEmpty()) return tD.EMPTY;
          let e = this;
          return (
        ...
        remove(e, t) {
          ...
          if (0 > t(e, r.key))
            ...
            if (
              ...
              if (r.right.isEmpty()) return tD.EMPTY;
              ((n = r.right.min()),
        ...
        moveRedRight() {
          let e = this.colorFlip();
          return (
            e.left.left.isRed() && (e = (e = e.rotateRight()).colorFlip()),
            e
          );
        }
        rotateLeft() {
          let e = this.copy(null, null, tD.RED, null, this.right.left);
          return this.right.copy(null, null, this.color, e, null);
        }
        rotateRight() {
          let e = this.copy(null, null, tD.RED, this.left.right, null);
        ...
        check() {
          if (this.isRed() && this.left.isRed())
            throw _(43730, { key: this.key, value: this.value });
          if (this.right.isRed())
            throw _(14113, { key: this.key, value: this.value });
          let e = this.left.check();
          if (e !== this.right.check()) throw _(27949);
          return e + +!this.isRed();
        }
      }
      ((tD.EMPTY = null),
      ...
      class tk {
        ...
        getIterator() {
          return new tA(this.data.getIterator());
        }
        getIteratorFrom(e) {
          return new tA(this.data.getIteratorFrom(e));
        }
        add(e) {
        ...
        isEqual(e) {
          if (!(e instanceof tk) || this.size !== e.size) return !1;
      ...
      class tR {
        constructor(e) {
          ((this.fields = e), e.sort(X.comparator));
        }
        static empty() {
          return new tR([]);
        }
        unionWith(e) {
          let t = new tk(X.comparator);
          for (let e of this.fields) t = t.add(e);
          for (let n of e) t = t.add(n);
          return new tR(t.toArray());
        }
        covers(e) {
        ...
        isEqual(e) {
          return K(this.fields, e.fields, (e, t) => e.isEqual(t));
        }
      }
            ...
            (function (e) {
              try {
                ...
                throw "undefined" != typeof DOMException &&
                  ...
                  ? new tO("Invalid base64 string: " + e)
                  : e;
              }
            })(e),
          );
      ...
      tM.EMPTY_BYTE_STRING = new tM("");
      let tF = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
      function tL(e) {
        if ((C(!!e, 39018), "string" == typeof e)) {
          let t = 0,
            n = tF.exec(e);
          if ((C(!!n, 46558, { timestamp: e }), n[1])) {
            let e = n[1];
            t = Number((e = (e + "000000000").substr(0, 9)));
          }
          return { seconds: Math.floor(new Date(e).getTime() / 1e3), nanos: t };
        }
        return { seconds: tP(e.seconds), nanos: tP(e.nanos) };
      }
      function tP(e) {
      ...
      function tU(e) {
        return "string" == typeof e
          ? tM.fromBase64String(e)
          : tM.fromUint8Array(e);
      }
      let tq = "server_timestamp",
        tB = "__type__",
      ...
      function tK(e) {
        ...
        return (
          (null ==
          (n = ((null == (t = null == e ? void 0 : e.mapValue)
            ? void 0
            : t.fields) || {})[tB])
            ? void 0
            : n.stringValue) === tq
      ...
      function tG(e) {
        let t = e.mapValue.fields[tz];
        return tK(t) ? tG(t) : t;
      }
      function tj(e) {
        let t = tL(e.mapValue.fields[t$].timestampValue);
      ...
      class tH {
        constructor(e, t) {
          ((this.projectId = e), (this.database = t || tY));
        }
        static empty() {
          return new tH("", "");
        }
        get isDefaultDatabase() {
          return this.database === tY;
        }
        isEqual(e) {
          return (
            e instanceof tH &&
      ...
      let tW = "__type__",
        tX = "__max__",
        tJ = { mapValue: { fields: { __type__: { stringValue: tX } } } },
        tZ = "__vector__",
        t0 = "value",
        t1 = { nullValue: "NULL_VALUE" };
      function t2(e) {
      ...
      function t5(e, t) {
        ...
        switch (n) {
          ...
          case 3:
            ...
            let r = tL(e.timestampValue),
              i = tL(t.timestampValue);
            return r.seconds === i.seconds && r.nanos === i.nanos;
          case 5:
            return e.stringValue === t.stringValue;
          case 6:
            return tU(e.bytesValue).isEqual(tU(t.bytesValue));
          case 7:
            return e.referenceValue === t.referenceValue;
          case 8:
            return (
              tP(e.geoPointValue.latitude) === tP(t.geoPointValue.latitude) &&
              tP(e.geoPointValue.longitude) === tP(t.geoPointValue.longitude)
            );
          case 2:
            if ("integerValue" in e && "integerValue" in t)
              return tP(e.integerValue) === tP(t.integerValue);
            if ("doubleValue" in e && "doubleValue" in t) {
              let n = tP(e.doubleValue),
                r = tP(t.doubleValue);
              return n === r ? eN(n) === eN(r) : isNaN(n) && isNaN(r);
            }
            return !1;
          case 9:
            return K(e.arrayValue.values || [], t.arrayValue.values || [], t5);
          case 10:
          case 11:
            let s = e.mapValue.fields || {},
              a = t.mapValue.fields || {};
            if (tx(s) !== tx(a)) return !1;
            for (let e in s)
              if (s.hasOwnProperty(e) && (void 0 === a[e] || !t5(s[e], a[e])))
                return !1;
            return !0;
          default:
            return _(52216, { left: e });
        }
      }
      function t4(e, t) {
        return void 0 !== (e.values || []).find((e) => t5(e, t));
      }
      function t3(e, t) {
        if (e === t) return 0;
        let n = t2(e),
        ...
        switch (n) {
          ...
          case 0x1fffffffffffff:
            return 0;
          case 1:
            return B(e.booleanValue, t.booleanValue);
          case 2:
            let i = tP(e.integerValue || e.doubleValue),
              s = tP(t.integerValue || t.doubleValue);
            return i < s
              ? -1
              : i > s
                ? 1
                : i === s
                  ...
                  : isNaN(i)
                    ...
                    : 1;
          case 3:
            return t6(e.timestampValue, t.timestampValue);
          case 4:
            return t6(tj(e), tj(t));
          case 5:
            return z(e.stringValue, t.stringValue);
          case 6:
            return (function (e, t) {
              let n = tU(e),
                r = tU(t);
          ...
          case 7:
            return (function (e, t) {
              ...
              return B(n.length, r.length);
            })(e.referenceValue, t.referenceValue);
          case 8:
            return (function (e, t) {
              let n = B(tP(e.latitude), tP(t.latitude));
              return 0 !== n ? n : B(tP(e.longitude), tP(t.longitude));
            })(e.geoPointValue, t.geoPointValue);
          case 9:
            return t8(e.arrayValue, t.arrayValue);
          case 10:
            return (function (e, t) {
              var n, r, i, s;
              let a = e.fields || {},
                o = t.fields || {},
                l = null == (n = a[t0]) ? void 0 : n.arrayValue,
                u = null == (r = o[t0]) ? void 0 : r.arrayValue,
                h = B(
                  (null == (i = null == l ? void 0 : l.values)
                    ? void 0
                    : i.length) || 0,
                  (null == (s = null == u ? void 0 : u.values)
                    ? void 0
                    : s.length) || 0,
                );
              return 0 !== h ? h : t8(l, u);
          ...
          case 11:
            return (function (e, t) {
              if (e === tJ.mapValue && t === tJ.mapValue) return 0;
              if (e === tJ.mapValue) return 1;
              if (t === tJ.mapValue) return -1;
              let n = e.fields || {},
                r = Object.keys(n),
                i = t.fields || {},
                s = Object.keys(i);
              ...
              for (let e = 0; e < r.length && e < s.length; ++e) {
                let t = z(r[e], s[e]);
                if (0 !== t) return t;
                let a = t3(n[r[e]], i[s[e]]);
                if (0 !== a) return a;
              }
              return B(r.length, s.length);
            })(e.mapValue, t.mapValue);
          default:
            throw _(23264, { Pe: n });
        }
      ...
      function t6(e, t) {
        ...
        return 0 !== i ? i : B(n.nanos, r.nanos);
      }
      function t8(e, t) {
        let n = e.values || [],
          r = t.values || [];
              ...
              : "doubleValue" in e
                ...
                : "timestampValue" in e
                  ...
                  : "stringValue" in e
                    ? e.stringValue
                    : "bytesValue" in e
                      ? tU(e.bytesValue).toBase64()
                      : "referenceValue" in e
                        ? ((t = e.referenceValue), J.fromName(t).toString())
                        : "geoPointValue" in e
                          ? ((n = e.geoPointValue),
      ...
      function na(e) {
        ...
        if (e.mapValue) {
          ...
          return (
            t_(e.mapValue.fields, (e, n) => (t.mapValue.fields[e] = na(n))),
            t
          );
        }
        if (e.arrayValue) {
          ...
          for (let n = 0; n < (e.arrayValue.values || []).length; ++n)
            t.arrayValue.values[n] = na(e.arrayValue.values[n]);
          return t;
        }
      ...
      function no(e) {
        return (
          (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === tX
        );
      }
      let nl = {
        mapValue: {
          fields: { [tW]: { stringValue: tZ }, [t0]: { arrayValue: {} } },
        },
      };
      function nu(e, t) {
        let n = t3(e.value, t.value);
        return 0 !== n
          ? n
      ...
      class nc {
        ...
        field(e) {
          if (e.isEmpty()) return this.value;
          {
            ...
            for (let n = 0; n < e.length - 1; ++n)
              if (!ni((t = (t.mapValue.fields || {})[e.get(n)]))) return null;
            return (t = (t.mapValue.fields || {})[e.lastSegment()]) || null;
          }
        }
        set(e, t) {
          this.getFieldsMap(e.popLast())[e.lastSegment()] = na(t);
        }
        setAll(e) {
          let t = X.emptyPath(),
            n = {},
          ...
          e.forEach((e, i) => {
            ...
            e ? (n[i.lastSegment()] = na(e)) : r.push(i.lastSegment());
          });
        ...
        applyChanges(e, t, n) {
          for (let r of (t_(t, (t, n) => (e[t] = n)), n)) delete e[r];
        }
        clone() {
          return new nc(na(this.value));
        }
      }
      class nd {
        ...
        static newInvalidDocument(e) {
          return new nd(e, 0, j.min(), j.min(), j.min(), nc.empty(), 0);
        }
        static newFoundDocument(e, t, n, r) {
          return new nd(e, 1, t, j.min(), n, r, 0);
        }
        static newNoDocument(e, t) {
          return new nd(e, 2, t, j.min(), j.min(), nc.empty(), 0);
        }
        static newUnknownDocument(e, t) {
          return new nd(e, 3, t, j.min(), j.min(), nc.empty(), 2);
        }
        convertToFoundDocument(e, t) {
          return (
            this.createTime.isEqual(j.min()) &&
        ...
        for (let i = 0; i < e.position.length; i++) {
          ...
          if (
            ((r = s.field.isKeyField()
              ? J.comparator(J.fromName(a.referenceValue), n.key)
              : t3(a, n.data.field(s.field))),
            "desc" === s.dir && (r *= -1),
            0 !== r)
          )
            break;
      ...
      function ng(e, t) {
        ...
        for (let n = 0; n < e.position.length; n++)
          if (!t5(e.position[n], t.position[n])) return !1;
        return !0;
      }
      class np {
        constructor(e, t = "asc") {
      ...
      class nw extends ny {
        ...
        static createKeyFieldInFilter(e, t, n) {
          return "in" === t ? new nS(e, n) : new nC(e, n);
        }
        matches(e) {
          ...
          return "!=" === this.op
            ? null !== t &&
                void 0 === t.nullValue &&
                this.matchesComparison(t3(t, this.value))
            : null !== t &&
                t2(this.value) === t2(t) &&
                this.matchesComparison(t3(t, this.value));
        }
        matchesComparison(e) {
          switch (this.op) {
            ...
            case ">=":
              return e >= 0;
            default:
              return _(47266, { operator: this.op });
          }
        }
        isInequality() {
      ...
      function nb(e) {
        for (let t of e.filters) if (t instanceof nv) return !1;
        return !0;
      }
      function nx(e, t) {
        let n = e.filters.concat(t);
        return nv.create(n, e.op);
      }
      class n_ extends nw {
        constructor(e, t, n) {
          (super(e, t, n), (this.key = J.fromName(n.referenceValue)));
        }
        matches(e) {
          let t = J.comparator(e.key, this.key);
          return this.matchesComparison(t);
        }
      }
      class nS extends nw {
        constructor(e, t) {
          (super(e, "in", t), (this.keys = nN("in", t)));
        }
        matches(e) {
      ...
      class nC extends nw {
        constructor(e, t) {
          (super(e, "not-in", t), (this.keys = nN("not-in", t)));
        }
        matches(e) {
          return !this.keys.some((t) => t.isEqual(e.key));
        }
      ...
      function nN(e, t) {
        var n;
        return ((null == (n = t.arrayValue) ? void 0 : n.values) || []).map(
          (e) => J.fromName(e.referenceValue),
        );
      }
      class nD extends nw {
        constructor(e, t) {
        ...
        matches(e) {
          let t = e.data.field(this.field);
          return nt(t) && t4(t.arrayValue, this.value);
        }
      }
      class nk extends nw {
        constructor(e, t) {
        ...
        matches(e) {
          let t = e.data.field(this.field);
          return null !== t && t4(this.value.arrayValue, t);
        }
      }
      class nA extends nw {
        constructor(e, t) {
        ...
        matches(e) {
          if (t4(this.value.arrayValue, { nullValue: "NULL_VALUE" })) return !1;
          let t = e.data.field(this.field);
          return (
            null !== t &&
            void 0 === t.nullValue &&
            !t4(this.value.arrayValue, t)
          );
        }
      }
      class nV extends nw {
        ...
        matches(e) {
          let t = e.data.field(this.field);
          return (
            !(!nt(t) || !t.arrayValue.values) &&
            t.arrayValue.values.some((e) => t4(this.value.arrayValue, e))
          );
        }
      }
      class nR {
      ...
      function nO(e, t = null, n = [], r = [], i = null, s = null, a = null) {
        return new nR(e, t, n, r, i, s, a);
      }
      function nM(e) {
        if (null === e.Ie) {
          ...
          (null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup),
            ...
            (t += e.filters
              .map((e) =>
                (function e(t) {
                  if (t instanceof nw)
                    return (
                      t.field.canonicalString() + t.op.toString() + t9(t.value)
                    );
                  if (nE(t)) return t.filters.map((t) => e(t)).join(",");
                  {
            ...
            (t += e.orderBy
              ...
              .join(",")),
            eC(e.limit) || ((t += "|l:"), (t += e.limit)),
            e.startAt &&
              ((t += "|lb:"),
              (t += e.startAt.inclusive ? "b:" : "a:"),
              (t += e.startAt.position.map((e) => t9(e)).join(","))),
            e.endAt &&
              ((t += "|ub:"),
              (t += e.endAt.inclusive ? "a:" : "b:"),
              (t += e.endAt.position.map((e) => t9(e)).join(","))),
            (e.Ie = t));
        }
        return e.Ie;
      }
      function nF(e, t) {
        ...
        return (
          ...
          !!ng(e.startAt, t.startAt) &&
          ng(e.endAt, t.endAt)
        );
      }
      function nL(e) {
        return (
          J.isDocumentKey(e.path) &&
          null === e.collectionGroup &&
          0 === e.filters.length
        );
      }
      function nP(e, t) {
        return e.filters.filter((e) => e instanceof nw && e.field.isEqual(t));
      }
      function nU(e, t, n) {
        let r = t1,
          i = !0;
        for (let n of nP(e, t)) {
          ...
          0 > nu({ value: r, inclusive: i }, { value: e, inclusive: t }) &&
            ((r = e), (i = t));
        }
        if (null !== n) {
      ...
      function nq(e, t, n) {
        ...
        for (let n of nP(e, t)) {
          ...
          nh({ value: r, inclusive: i }, { value: e, inclusive: t }) > 0 &&
            ((r = e), (i = t));
        }
        if (null !== n) {
          for (let s = 0; s < e.orderBy.length; ++s)
        ...
        if (null === e.Ee) {
          ...
          t).forEach((t) => {
            n.has(t.canonicalString()) ||
              t.isKeyField() ||
              e.Ee.push(new np(t, r));
          }),
            n.has(X.keyField().canonicalString()) ||
              e.Ee.push(new np(X.keyField(), r)));
        }
        return e.Ee;
      }
      function nj(e) {
        return (e.de || (e.de = nQ(e, nG(e))), e.de);
      }
      function nQ(e, t) {
        if ("F" === e.limitType)
          return nO(
          ...
          );
        {
          t = t.map((e) => {
            ...
            return new np(e.field, t);
          });
          let n = e.endAt ? new nf(e.endAt.position, e.endAt.inclusive) : null,
            r = e.startAt
              ? new nf(e.startAt.position, e.startAt.inclusive)
              : null;
          return nO(e.path, e.collectionGroup, t, e.filters, e.limit, n, r);
        }
      }
      function nY(e, t) {
        let n = e.filters.concat([t]);
      ...
      function nW(e, t) {
        return nF(nj(e), nj(t)) && e.limitType === t.limitType;
      }
      function nX(e) {
        return `${nM(nj(e))}|lt:${e.limitType}`;
      }
      function nJ(e) {
        var t;
        let n;
        return `Query(target=${
          ((n = (t = nj(e)).path.canonicalString()),
          ...
          t.filters.length > 0 &&
            (n += `, filters: [${t.filters
              .map((e) =>
                (function e(t) {
                  return t instanceof nw
                    ? `${t.field.canonicalString()} ${t.op} ${t9(t.value)}`
                    : t instanceof nv
                      ? t.op.toString() +
                        " {" +
              ...
              let r = e.field.isKeyField()
                ...
                : (function (e, t, n) {
                    let r = t.data.field(e),
                      i = n.data.field(e);
                    return null !== r && null !== i ? t3(r, i) : _(42886);
                  })(e.field, t, n);
              switch (e.dir) {
                case "asc":
                  return r;
                case "desc":
                  return -1 * r;
                default:
                  return _(19790, { direction: e.dir });
              }
            })(i, t, n);
            if (0 !== e) return e;
      ...
      class n2 {
        ...
        isEmpty() {
          return tS(this.inner);
        }
        size() {
          return this.innerSize;
        }
      }
      let n5 = new tC(J.comparator),
        n4 = new tC(J.comparator);
      function n3(...e) {
        let t = n4;
      ...
      let n9 = new tC(J.comparator),
        n7 = new tk(J.comparator);
      function re(...e) {
        let t = n7;
        for (let n of e) t = t.add(n);
        return t;
      ...
      function rn(e, t) {
        ...
        return { doubleValue: eN(t) ? "-0" : t };
      }
      function rr(e) {
        return { integerValue: "" + e };
      }
      function ri(e, t) {
        return eD(t) ? rr(t) : rn(e, t);
      }
      class rs {
        constructor() {
          this._ = void 0;
      ...
      function ru(e, t) {
        let n = rm(t);
        for (let t of e.elements) n.some((e) => t5(e, t)) || n.push(t);
      ...
      function rc(e, t) {
        let n = rm(t);
        for (let t of e.elements) n = n.filter((e) => !t5(e, t));
        return { arrayValue: { values: n } };
      }
      class rd extends rs {
        constructor(e, t) {
      ...
      function rf(e) {
        return tP(e.integerValue || e.doubleValue);
      }
      function rm(e) {
        return nt(e) && e.arrayValue.values ? e.arrayValue.values.slice() : [];
      }
      class rg {
        constructor(e, t) {
      ...
      function rI(e, t) {
        ...
        if (null === t)
          return e.isNoDocument()
            ? new rN(e.key, ry.none())
            : new rb(e.key, e.data, ry.none());
        {
          let n = e.data,
            r = nc.empty(),
            i = new tk(X.comparator);
          ...
          return new rx(e.key, r, new tR(i.toArray()), ry.none());
        }
      }
      function rT(e, t, n, r) {
        return e instanceof rb
          ? (function (e, t, n, r) {
              if (!rw(e.precondition, t)) return n;
              let i = e.value.clone(),
                s = rC(e.fieldTransforms, r, t);
              return (
                i.setAll(s),
          ...
          : e instanceof rx
            ? (function (e, t, n, r) {
                if (!rw(e.precondition, t)) return n;
                let i = rC(e.fieldTransforms, r, t),
                  s = t.data;
                return (s.setAll(r_(e)),
                s.setAll(i),
            ...
            (!(!n || !r) &&
              K(n, r, (e, t) => {
                ...
                return (
                  ...
                  ((n = e.transform),
                  (r = t.transform),
                  (n instanceof rl && r instanceof rl) ||
                  (n instanceof rh && r instanceof rh)
                    ? K(n.elements, r.elements, t5)
                    : n instanceof rd && r instanceof rd
                      ? t5(n.Re, r.Re)
                      : n instanceof ro && r instanceof ro)
                );
              }))
          )) &&
          (0 === e.type
      ...
      function rS(e, t, n) {
        let r = new Map();
        C(e.length === n.length, 32656, { Ve: n.length, me: e.length });
        for (let s = 0; s < n.length; s++) {
          ...
          r.set(
            a.field,
            ((i = n[s]),
            o instanceof rl ? ru(o, l) : o instanceof rh ? rc(o, l) : i),
          );
        }
        return r;
      }
              ...
              : e instanceof rl
                ...
                : e instanceof rh
                  ...
                  : (function (e, t) {
                      let n = ra(e, t),
                        r = rf(n) + rf(e.Re);
                      return ne(n) && ne(e.Re) ? rr(r) : rn(e.serializer, r);
                    })(e, s),
          );
        }
        return r;
            ...
            r.key.isEqual(e.key) &&
              (function (e, t, n) {
                e instanceof rb
                  ? (function (e, t, n) {
                      let r = e.value.clone(),
                        i = rS(e.fieldTransforms, t, n.transformResults);
                      (r.setAll(i),
                        t
                  ...
                  : e instanceof rx
                    ? (function (e, t, n) {
                        if (!rw(e.precondition, t))
                          return t.convertToUnknownDocument(n.version);
                        let r = rS(e.fieldTransforms, t, n.transformResults),
                          i = t.data;
                        (i.setAll(r_(e)),
                          i.setAll(r),
                          t
          ...
          return (
            this.mutations.forEach((r) => {
              let i = e.get(r.key),
                ...
                o = rI(s, (a = t.has(r.key) ? null : a));
              (null !== o && n.set(r.key, o),
                s.isValidDocument() || s.convertToNoDocument(j.min()));
            }),
            n
          );
        }
        keys() {
          return this.mutations.reduce((e, t) => e.add(t.key), re());
        }
        isEqual(e) {
          return (
            this.batchId === e.batchId &&
            K(this.mutations, e.mutations, (e, t) => rE(e, t)) &&
            K(this.baseMutations, e.baseMutations, (e, t) => rE(e, t))
          );
        }
      }
      class rA {
        ...
        static from(e, t, n) {
          C(e.mutations.length === n.length, 58842, {
      ...
      function rO(e) {
        switch (e) {
          ...
          case N.DATA_LOSS:
            return !0;
          default:
            return _(15467, { code: e });
        }
      }
      function rM(e) {
        if (void 0 === e) return (E("GRPC error has no .code"), N.UNKNOWN);
        switch (e) {
          case r.OK:
            return N.OK;
          case r.CANCELLED:
      ...
      let rF = new c.jz([0xffffffff, 0xffffffff], 0);
      function rL(e) {
        let t = U().encode(e),
          n = new c.VV();
      ...
      class rU {
        constructor(e, t, n) {
          if (
            ...
            throw new rq(`Invalid padding: ${t}`);
          if (n < 0 || (e.length > 0 && 0 === this.hashCount))
            throw new rq(`Invalid hash count: ${n}`);
          if (0 === e.length && 0 !== t)
            throw new rq(`Invalid padding when bitmap length is 0: ${t}`);
          ((this.pe = 8 * e.length - t), (this.ye = c.jz.fromNumber(this.pe)));
        }
        we(e, t, n) {
      ...
      class rB {
        ...
        static createSynthesizedRemoteEventForCurrentChange(e, t, n) {
          let r = new Map();
          return (
            r.set(e, rz.createSynthesizedTargetChangeForCurrentChange(e, t, n)),
            new rB(j.min(), r, new tC(B), n5, re())
          );
        }
      }
      class rz {
      ...
      class rG {
        constructor(e, t, n = tM.EMPTY_BYTE_STRING, r = null) {
          ((this.state = e),
            (this.targetIds = t),
            (this.resumeToken = n),
            (this.cause = r));
      ...
      class rj {
            ...
            this.Me.forEach((r, i) => {
              switch (i) {
                ...
                case 1:
                  ...
                  break;
                default:
                  _(38017, { changeType: i });
              }
            }),
            new rz(this.xe, this.Oe, e, t, n)
          );
        }
        Qe() {
          ((this.Ne = !1), (this.Me = rH()));
        }
        $e(e, t) {
        ...
        We() {
          ((this.Fe -= 1), C(this.Fe >= 0, 3241, { Fe: this.Fe }));
        }
        Ge() {
          ((this.Ne = !0), (this.Oe = !0));
        }
      ...
      class rQ {
        ...
        Xe(e) {
          ...
          for (let t of e.removedTargetIds) this.tt(t, e.key, e.ve);
        }
        nt(e) {
          this.forEachTarget(e, (t) => {
            ...
            switch (e.state) {
              case 0:
                ...
                break;
              case 1:
                (n.We(), n.Be || n.Qe(), n.ke(e.resumeToken));
                break;
              case 2:
              ...
              case 3:
                ...
                break;
              case 4:
                this.it(t) && (this.st(t), n.ke(e.resumeToken));
                break;
              default:
                _(56790, { state: e.state });
            }
          });
        }
        forEachTarget(e, t) {
        ...
        ot(e) {
          ...
          if (r) {
            ...
            if (nL(i))
              if (0 === n) {
                let e = new J(i.path);
                this.tt(t, e, nd.newNoDocument(e, j.min()));
              } else C(1 === n, 20013, { expectedCount: n });
            else {
              let r = this.ut(t);
              if (r !== n) {
                let n = this.ct(e),
        ...
        ct(e) {
          ...
          return 0 === n.pe ? null : n;
        }
        lt(e, t, n) {
          return 2 * (t.Ce.count !== n - this.Tt(e, t.targetId));
        }
        Tt(e, t) {
          let n = this.ze.getRemoteKeysForTarget(t),
            r = 0;
          return (
            n.forEach((n) => {
              let i = this.ze.Pt(),
                s = `projects/${i.projectId}/databases/${i.database}/documents/${n.path.canonicalString()}`;
              e.mightContain(s) || (this.tt(t, n, null), r++);
            }),
            r
          );
        }
        It(e) {
          ...
          this.je.forEach((n, r) => {
            let i = this._t(r);
            if (i) {
              if (n.current && nL(i.target)) {
                let t = new J(i.target.path);
                this.Et(t).has(r) ||
                  this.dt(r, t) ||
                  this.tt(r, t, nd.newNoDocument(t, e));
              }
          ...
          let r = new rB(e, t, this.Ze, this.He, n);
          return (
            (this.He = n5),
            (this.Je = rY()),
            (this.Ye = rY()),
        ...
        rt(e) {
          let t = this.je.get(e);
          return (t || ((t = new rj()), this.je.set(e, t)), t);
        }
        At(e) {
          let t = this.Ye.get(e);
          return (t || ((t = new tk(B)), (this.Ye = this.Ye.insert(e, t))), t);
        }
        Et(e) {
          let t = this.Je.get(e);
          return (t || ((t = new tk(B)), (this.Je = this.Je.insert(e, t))), t);
        }
        it(e) {
          let t = null !== this._t(e);
          return (
            t || T("WatchChangeAggregator", "Detected inactive target", e),
            t
          );
        }
        _t(e) {
      ...
      function r4(e, t) {
        return r3(e, t).canonicalString();
      }
      function r3(e, t) {
        let n = new H(["projects", e.projectId, "databases", e.database]).child(
          "documents",
        );
      ...
      function r6(e) {
        ...
        return (C(im(t), 10190, { key: t.toString() }), t);
      }
      function r8(e, t) {
        return r4(e.databaseId, t.path);
      }
      function r9(e, t) {
        let n = r6(t);
      ...
      function r7(e, t) {
        return r4(e.databaseId, t);
      }
      function ie(e) {
        let t = r6(e);
        return 4 === t.length ? H.emptyPath() : ir(t);
      }
      function it(e) {
        return new H([
          "projects",
      ...
      function ir(e) {
        return (
          C(e.length > 4 && "documents" === e.get(4), 29091, {
            key: e.toString(),
          }),
          e.popFirst(5)
        );
      ...
      function ii(e, t, n) {
        return { name: r8(e, t), fields: n.value.mapValue.fields };
      }
      function is(e, t, n) {
        let r = r9(e, t.name),
          i = r5(t.updateTime),
          s = t.createTime ? r5(t.createTime) : j.min(),
          a = new nc({ mapValue: { fields: t.fields } }),
          o = nd.newFoundDocument(r, i, s, a);
        return (
      ...
      function ia(e, t) {
        var n;
        let r;
        if (t instanceof rb) r = { update: ii(e, t.key, t.value) };
        else if (t instanceof rN) r = { delete: r8(e, t.key) };
        else if (t instanceof rx)
          r = {
            update: ii(e, t.key, t.data),
          ...
          if (!(t instanceof rD)) return _(16599, { ft: t.type });
          r = { verify: r8(e, t.key) };
        }
        return (
          t.fieldTransforms.length > 0 &&
            (r.updateTransforms = t.fieldTransforms.map((e) =>
              (function (e, t) {
                ...
                throw _(20930, { transform: t.transform });
              })(0, e),
            )),
          t.precondition.isNone ||
            (r.currentDocument =
              void 0 !== (n = t.precondition).updateTime
                ? { updateTime: r1(e, n.updateTime.toTimestamp()) }
                : void 0 !== n.exists
                  ? { exists: n.exists }
                  : _(27497)),
          r
      ...
      function io(e, t) {
        var n;
        let r = t.currentDocument
            ? void 0 !== (n = t.currentDocument).updateTime
              ? ry.updateTime(r5(n.updateTime))
              : void 0 !== n.exists
                ? ry.exists(n.exists)
                : ry.none()
            : ry.none(),
          i = t.updateTransforms
            ? t.updateTransforms.map((t) => {
                ...
                return (
                  (n = null),
                  "setToServerValue" in t
                    ? (C("REQUEST_TIME" === t.setToServerValue, 16630, {
                        proto: t,
                      }),
                      (n = new ro()))
                    : "appendMissingElements" in t
                      ? (n = new rl(t.appendMissingElements.values || []))
                      : "removeAllFromArray" in t
                        ? (n = new rh(t.removeAllFromArray.values || []))
                        : "increment" in t
                          ? (n = new rd(e, t.increment))
                          : _(16584, { proto: t }),
                  new rg(X.fromServerFormat(t.fieldPath), n)
                );
              })
            : [];
        if (t.update) {
          t.update.name;
          let n = r9(e, t.update.name),
            s = new nc({ mapValue: { fields: t.update.fields } });
          return t.updateMask
            ? new rx(
                n,
                s,
        ...
        return t.delete
          ? new rN(r9(e, t.delete), r)
          : t.verify
            ? new rD(r9(e, t.verify), r)
            : _(1463, { proto: t });
      }
      function il(e, t) {
        return { documents: [r7(e, t.path)] };
      }
      function iu(e, t) {
        var n, r;
        let i,
              ...
              return t instanceof nw
                ? (function (e) {
                    if ("==" === e.op) {
                      if (nr(e.value))
                        return {
                          unaryFilter: { field: ic(e.field), op: "IS_NAN" },
                        };
                      if (nn(e.value))
                        return {
                          unaryFilter: { field: ic(e.field), op: "IS_NULL" },
                        };
                    } else if ("!=" === e.op) {
                      if (nr(e.value))
                        return {
                          unaryFilter: { field: ic(e.field), op: "IS_NOT_NAN" },
                        };
                      if (nn(e.value))
                        return {
                          unaryFilter: {
                ...
                : t instanceof nv
                  ? (function (t) {
                      ...
                      return 1 === n.length
                        ? n[0]
                        : { compositeFilter: { op: rJ[t.op], filters: n } };
                    })(t)
                  : _(54877, { filter: t });
            })(nv.create(e, "and"));
        })(t.filters);
        ...
        let l = (function (e) {
          if (0 !== e.length)
            return e.map((e) => ({ field: ic(e.field), direction: rW[e.dir] }));
        })(t.orderBy);
      ...
      function ih(e) {
        ...
        i.where &&
          (o = (function (e) {
              ...
              return void 0 !== t.unaryFilter
                ? (function (e) {
                    switch (e.unaryFilter.op) {
                      case "IS_NAN":
                        let t = id(e.unaryFilter.field);
                        return nw.create(t, "==", { doubleValue: NaN });
                      case "IS_NULL":
                        let n = id(e.unaryFilter.field);
                        return nw.create(n, "==", { nullValue: "NULL_VALUE" });
                      case "IS_NOT_NAN":
                        let r = id(e.unaryFilter.field);
                        return nw.create(r, "!=", { doubleValue: NaN });
                      case "IS_NOT_NULL":
                        let i = id(e.unaryFilter.field);
                        return nw.create(i, "!=", { nullValue: "NULL_VALUE" });
            ...
            return t instanceof nv && nE(t) ? t.getFilters() : [t];
          })(i.where));
        let l = [];
        i.orderBy &&
          (l = i.orderBy.map(
        ...
        let u = null;
        i.limit &&
          (u = eC((n = "object" == typeof (t = i.limit) ? t.value : t))
            ? null
            : n);
        let h = null;
        i.startAt &&
      ...
      function id(e) {
        return X.fromServerFormat(e.fieldPath);
      }
      function im(e) {
        return (
      ...
      function iy(e, t) {
        let n = t.key,
          r = {
            ...
            readTime: iw(t.readTime),
            hasCommittedMutations: t.hasCommittedMutations,
          };
        if (t.isFoundDocument()) {
          var i;
          r.document = {
            name: r8((i = e.wt), t.key),
            fields: t.data.value.mapValue.fields,
            updateTime: r1(i, t.version.toTimestamp()),
            createTime: r1(i, t.createTime.toTimestamp()),
          };
        } else if (t.isNoDocument())
          r.noDocument = { path: n.path.toArray(), readTime: iv(t.version) };
        else {
          if (!t.isUnknownDocument()) return _(57904, { document: t });
          r.unknownDocument = {
            path: n.path.toArray(),
            version: iv(t.version),
          };
        }
        return r;
      }
      ...
      function iI(e) {
        let t = new G(e.seconds, e.nanoseconds);
        return j.fromTimestamp(t);
      }
      function iT(e, t) {
        let n = (t.baseMutations || []).map((t) => io(e.wt, t));
        ...
        let r = t.mutations.map((t) => io(e.wt, t)),
          i = G.fromMillis(t.localWriteTimeMs);
        return new rk(t.batchId, i, n, r);
      }
      function iE(e) {
        let t = iI(e.readTime),
          n =
            void 0 !== e.lastLimboFreeSnapshotVersion
              ? iI(e.lastLimboFreeSnapshotVersion)
              : j.min();
        return new ig(
          ...
          t,
          n,
          tM.fromBase64String(e.resumeToken),
        );
      }
      function ib(e, t) {
        let n,
          r = iv(t.snapshotVersion),
          i = iv(t.lastLimboFreeSnapshotVersion);
        n = nL(t.target) ? il(e.wt, t.target) : iu(e.wt, t.target).gt;
        let s = t.resumeToken.toBase64();
        return {
          targetId: t.targetId,
          canonicalId: nM(t.target),
          readTime: r,
          resumeToken: s,
      ...
      function ix(e) {
        let t = ih({ parent: e.parent, structuredQuery: e.structuredQuery });
        return "LAST" === e.limitType ? nH(t, t.limit, "L") : t;
      }
      function i_(e, t) {
        return new rV(t.largestBatchId, io(e.wt, t.overlayMutation));
      }
      function iS(e, t) {
        let n = t.path.lastSegment();
        return [e, ek(t.path.popLast()), n];
      }
      function iC(e, t, n, r) {
        return {
          indexId: e,
          uid: t,
          sequenceNumber: n,
          readTime: iv(r.readTime),
          documentKey: ek(r.documentKey.path),
          ...
          return tb(e, e7)
            ...
            .next((e) => {
              if (e)
                return {
                  name: e.name,
                  query: ix(e.bundledQuery),
                  readTime: iI(e.readTime),
                };
            });
        }
        saveNamedQuery(e, t) {
      ...
      class iD {
        ...
        static bt(e, t) {
          return new iD(e, t.uid || "");
        }
        getOverlay(e, t) {
          return tb(e, th)
            .get(iS(this.userId, t))
            .next((e) => (e ? i_(this.serializer, e) : null));
        }
        getOverlays(e, t) {
          let n = n8();
          return ec
        ...
        removeOverlaysForBatchId(e, t, n) {
          let r = new Set();
          t.forEach((e) => r.add(ek(e.getCollectionPath())));
          let i = [];
          return (
            r.forEach((t) => {
        ...
        getOverlaysForCollectionGroup(e, t, n, r) {
          ...
          return tb(e, th)
            .te({ index: tm, range: a }, (e, t, n) => {
              let a = i_(this.serializer, t);
          ...
          return tb(e, th).put(
            (function (e, t, n) {
              ...
              return {
                ...
                overlayMutation: ia(e.wt, n.mutation),
              };
        ...
        getSessionToken(e) {
          return this.Dt(e)
            ...
            .next((e) => {
              ...
              return t ? tM.fromUint8Array(t) : tM.EMPTY_BYTE_STRING;
            });
        }
        setSessionToken(e, t) {
      ...
      class iA {
        ...
        Ct(e, t) {
          if ("nullValue" in e) this.Mt(t, 5);
            ...
            (this.Mt(t, 10), t.xt(+!!e.booleanValue));
          else if ("integerValue" in e)
            (this.Mt(t, 15), t.xt(tP(e.integerValue)));
          else if ("doubleValue" in e) {
            let n = tP(e.doubleValue);
            isNaN(n)
              ? this.Mt(t, 13)
              : (this.Mt(t, 15), eN(n) ? t.xt(0) : t.xt(n));
            ...
            (this.Mt(t, 30), t.Lt(tU(e.bytesValue)), this.Bt(t));
        ...
        Qt(e, t) {
          let n = e.fields || {};
          for (let e of (this.Mt(t, 55), Object.keys(n)))
            (this.Nt(e, t), this.Ct(n[e], t));
        }
        qt(e, t) {
          var n, r;
          let i = e.fields || {};
          this.Mt(t, 53);
          let s =
            (null == (r = null == (n = i[t0].arrayValue) ? void 0 : n.values)
              ? void 0
              : r.length) || 0;
          (this.Mt(t, 15), t.xt(tP(s)), this.Nt(t0, t), this.Ct(i[t0], t));
        }
        $t(e, t) {
          let n = e.values || [];
          for (let e of (this.Mt(t, 50), n)) this.Ct(e, t);
        }
        kt(e, t) {
          (this.Mt(t, 37),
            J.fromName(e).path.forEach((e) => {
      ...
      class iR {
        ...
        Zt(e) {
          for (let t of e) {
            ...
            if (e < 128) this.zt(e);
              ...
              (this.zt(960 | (e >>> 6)), this.zt(128 | (63 & e)));
            else if (t < "\ud800" || "\udbff" < t)
              (this.zt(480 | (e >>> 12)),
                this.zt(128 | (63 & (e >>> 6))),
                this.zt(128 | (63 & e)));
        ...
        Xt(e) {
          for (let t of e) {
            ...
            if (e < 128) this.Jt(e);
              ...
              (this.Jt(960 | (e >>> 6)), this.Jt(128 | (63 & e)));
            else if (t < "\ud800" || "\udbff" < t)
              (this.Jt(480 | (e >>> 12)),
                this.Jt(128 | (63 & (e >>> 6))),
                this.Jt(128 | (63 & e)));
        ...
        sn() {
          (this._n(255), this._n(255));
        }
        an() {
          (this.un(255), this.un(255));
        }
        reset() {
          this.position = 0;
        }
      ...
      class iF {
        constructor() {
          ((this.ln = new iR()),
            (this.hn = new iO(this.ln)),
            (this.Pn = new iM(this.ln)));
        }
        seed(e) {
          this.ln.seed(e);
        }
      ...
      class iL {
        ...
        Vn(e, t, n) {
          return {
            indexId: this.In,
            uid: e,
            arrayValue: iq(this.dn),
            directionalValue: iq(this.An),
            orderedDocumentKey: iq(t),
      ...
      class iz {
        constructor(e) {
          for (let t of ((this.fn = new tk((e, t) =>
            X.comparator(e.field, t.field),
          )),
          (this.collectionId =
            null != e.collectionGroup
              ? e.collectionGroup
          ...
          (this.pn = []),
          e.filters))
            t.isInequality() ? (this.fn = this.fn.add(t)) : this.pn.push(t);
        }
        get yn() {
          return this.fn.size > 1;
        }
        wn(e) {
          if ((C(e.collectionGroup === this.collectionId, 49279), this.yn))
            return !1;
          let t = ee(e);
          ...
          if (this.fn.size > 0) {
            let e = this.fn.getIterator().getNext();
        ...
        vn() {
          ...
          let e = new tk(X.comparator),
            t = [];
          for (let n of this.pn)
            if (!n.field.isKeyField())
              if ("array-contains" === n.op || "array-contains-any" === n.op)
                t.push(new en(n.field, 2));
              else {
                if (e.has(n.field)) continue;
                ((e = e.add(n.field)), t.push(new en(n.field, 0)));
              }
          for (let n of this.gn)
            n.field.isKeyField() ||
              e.has(n.field) ||
              ((e = e.add(n.field)),
              t.push(new en(n.field, +("asc" !== n.dir))));
          return new Z(Z.UNKNOWN_ID, this.collectionId, t, er.empty());
        }
        bn(e) {
          for (let t of this.pn) if (this.Sn(t, e)) return !0;
          return !1;
        }
        Sn(e, t) {
      ...
      function iG(e) {
        return (
          ...
          iK(e) ||
          (function (e) {
            if (e instanceof nv && nT(e)) {
              for (let t of e.getFilters()) if (!i$(t) && !iK(t)) return !1;
              return !0;
            }
            return !1;
          })(e)
      ...
      function ij(e, t) {
        return (
          C(e instanceof nw || e instanceof nv, 38388),
          C(t instanceof nw || t instanceof nv, 25473),
          iY(
            e instanceof nw
              ? t instanceof nw
                ? nv.create([e, t], "and")
              ...
              : t instanceof nw
                ...
                : (function (e, t) {
                    if (
                      (C(e.filters.length > 0 && t.filters.length > 0, 48005),
                      nI(e) && nI(t))
                    )
                      return nx(e, t.getFilters());
                    let n = nT(e) ? e : t,
                      r = nT(e) ? t : e,
                      i = n.filters.map((e) => ij(e, r));
                    return nv.create(i, "or");
                  })(e, t),
          )
        );
      }
      function iQ(e, t) {
        if (nI(t)) return nx(t, e.getFilters());
        {
          let n = t.filters.map((t) => ij(e, t));
          return nv.create(n, "or");
        }
      }
      function iY(e) {
        if ((C(e instanceof nw || e instanceof nv, 11850), e instanceof nw))
          return e;
        let t = e.getFilters();
        if (1 === t.length) return iY(t[0]);
        if (nb(e)) return e;
        let n = t.map((e) => iY(e)),
          r = [];
        return (
          ...
          1 === r.length ? r[0] : nv.create(r, e.op)
        );
      }
      class iH {
        constructor() {
        ...
        addToCollectionParentIndex(e, t) {
          return (this.Cn.add(t), ec.resolve());
        }
        getCollectionParents(e, t) {
          return ec.resolve(this.Cn.getEntries(t));
        }
        addFieldIndex(e, t) {
          return ec.resolve();
        }
      ...
      class iW {
        ...
        add(e) {
          let t = e.lastSegment(),
            n = e.popLast(),
            r = this.index[t] || new tk(H.comparator),
            i = !r.has(n);
        ...
        getEntries(e) {
          return (this.index[e] || new tk(H.comparator)).toArray();
        }
      }
      let iX = "IndexedDbIndexManager",
        iJ = new Uint8Array(0);
      class iZ {
        constructor(e, t) {
          ((this.databaseId = t),
        ...
        addToCollectionParentIndex(e, t) {
          if (!this.Fn.has(t)) {
            ...
            let i = { collectionId: n, parent: ek(r) };
            return tb(e, e3).put(i);
          }
          return ec.resolve();
        }
        getCollectionParents(e, t) {
              ...
              if (r) {
                ...
                return ec
                  .forEach(i, (i, s) => {
                    T(
                      iX,
                      `Using index id=${i.indexId}|cg=${i.collectionGroup}|f=${i.fields.map((e) => `${e.fieldPath}:${e.kind}`).join(",")} to execute ${nM(t)}`,
                    );
                    let a = (function (e, t) {
                        let n = ee(t);
                        if (void 0 === n) return null;
                        for (let t of nP(e, n.fieldPath))
                          switch (t.op) {
                      ...
                      l = (function (e, t) {
                        ...
                        for (let i of et(t)) {
                          let t =
                            0 === i.kind
                              ? nU(e, i.fieldPath, e.startAt)
                              : nq(e, i.fieldPath, e.startAt);
                      ...
                      u = (function (e, t) {
                        ...
                        for (let i of et(t)) {
                          let t =
                            0 === i.kind
                              ? nq(e, i.fieldPath, e.endAt)
                              : nU(e, i.fieldPath, e.endAt);
                          (n.push(t.value), r && (r = t.inclusive));
                        }
                        return new nf(n, r);
                      })(s, i),
                    ...
                    return ec.forEach(f, (i) =>
                      n.Z(i, t.limit).next((t) => {
                        t.forEach((t) => {
                          let n = J.fromSegments(t.documentKey);
              ...
              ((t =
                0 === e.filters.length
                  ...
                  : (function (e) {
                      ...
                      let t = (function e(t) {
                        if (
                          (C(t instanceof nw || t instanceof nv, 34018),
                          t instanceof nw)
                        )
                          return t;
                        ...
                        return iG((r = iY(r)))
                          ? r
                          : (C(r instanceof nv, 64498),
                            C(nI(r), 40251),
                            C(r.filters.length > 1, 57927),
                            r.filters.reduce((e, t) => ij(e, t)));
                      })(
                        (function e(t) {
                          var n, r;
                          if (
                            (C(t instanceof nw || t instanceof nv, 20012),
                            t instanceof nw)
                          ) {
                            if (t instanceof nk) {
                              let e =
                              ...
                              return nv.create(e, "or");
                            }
                            return t;
                          }
                          let i = t.filters.map((t) => e(t));
                          return nv.create(i, t.op);
                        })(e),
                      );
                      return (
                        C(iG(t), 7391),
                        i$(t) || iK(t) ? [t] : t.getFilters()
                      );
                    })(nv.create(e.filters, "and")).map((t) =>
                      nO(
                        e.path,
                        e.collectionGroup,
                        e.orderBy,
        ...
        Ln(e, t, n, r, i, s, a) {
          let o = (null != t ? t.length : 1) * Math.max(n.length, i.length),
            ...
            u = [];
          for (let h = 0; h < o; ++h) {
            let o = t ? this.kn(t[h / l]) : iJ,
              c = this.qn(e, o, n[h % l], r),
              d = this.Qn(e, o, i[h % l], s),
              f = a.map((t) => this.qn(e, o, t, !0));
            u.push(...this.createRange(c, d, f));
          }
          return u;
        }
        qn(e, t, n, r) {
          let i = new iL(e, J.empty(), t, n);
          return r ? i : i.Rn();
        }
        Qn(e, t, n, r) {
          let i = new iL(e, J.empty(), t, n);
        ...
        kn(e) {
          let t = new iF();
          return (iA.Wt.vt(e, t.Tn(0)), t.cn());
        }
        Un(e, t) {
          let n = new iF();
          return (
            iA.Wt.vt(
              t7(this.databaseId, t),
              n.Tn(
                (function (e) {
                  let t = et(e);
        ...
        Bn(e, t, n) {
          ...
          for (let s of et(e)) {
            let e = n[i++];
            for (let n of r)
              if (this.Kn(t, s.fieldPath) && nt(e)) r = this.Wn(r, s, e);
              else {
                let t = n.Tn(s.kind);
                iA.Wt.vt(e, t);
              }
        ...
        Wn(e, t, n) {
          ...
          for (let e of n.arrayValue.values || [])
            for (let n of r) {
              let r = new iF();
              (r.seed(n.cn()), iA.Wt.vt(e, r.Tn(t.kind)), i.push(r));
            }
          return i;
        }
        Kn(e, t) {
        ...
        getFieldIndexes(e, t) {
          let n = tb(e, te),
            r = tb(e, tn);
          return (t ? n.J(tt, IDBKeyRange.bound(t, t)) : n.J()).next((e) => {
            let t = [];
            return ec
              .forEach(e, (e) =>
                    ...
                    (function (e, t) {
                      let n = t
                          ? new er(
                              ...
                              new ea(
                                iI(t.readTime),
                                new J(eA(t.documentKey)),
                                t.largestBatchId,
                              ),
                            )
                          : er.empty(),
                        r = e.fields.map(
                          ([e, t]) => new en(X.fromServerFormat(e), t),
                        );
          ...
          return this.getFieldIndexes(e).next((e) =>
            0 === e.length
              ...
              : (e.sort((e, t) => {
                  ...
                  return 0 !== n ? n : B(e.collectionGroup, t.collectionGroup);
                }),
                e[0].collectionGroup),
          );
        }
        updateCollectionGroup(e, t, n) {
          let r = tb(e, te),
            i = tb(e, tn);
          return this.zn(e).next((e) =>
            r
              .J(tt, IDBKeyRange.bound(t, t))
              .next((t) =>
                ec.forEach(t, (t) => i.put(iC(t.indexId, this.uid, e, n))),
              ),
          );
        }
        updateIndexEntries(e, t) {
          let n = new Map();
          return ec.forEach(t, (t, r) => {
            let i = n.get(t.collectionGroup);
            return (
              i ? ec.resolve(i) : this.getFieldIndexes(e, t.collectionGroup)
            ).next(
              (i) => (
                n.set(t.collectionGroup, i),
                ec.forEach(i, (n) =>
                  this.jn(e, t, n).next((t) => {
                    let i = this.Hn(r, n);
                    return t.isEqual(i) ? ec.resolve() : this.Jn(e, r, n, t, i);
                  }),
                )
              ),
            );
        ...
        Yn(e, t, n, r) {
          return tb(e, ta).put(r.Vn(this.uid, this.Un(n, t.key), t.key));
        }
        Zn(e, t, n, r) {
          return tb(e, ta).delete(r.mn(this.uid, this.Un(n, t.key), t.key));
        }
        jn(e, t, n) {
          let r = tb(e, ta),
            i = new tk(iP);
          ...
          if (null != i) {
            ...
            if (nt(s))
              for (let i of s.arrayValue.values || [])
                n = n.add(new iL(t.indexId, e.key, this.kn(i), r));
          } else n = n.add(new iL(t.indexId, e.key, iJ, r));
          return n;
        }
        Jn(e, t, n, r, i) {
          T(iX, "Updating index entries for document '%s'", t.key);
          let s = [];
          return (
            (function (e, t, n, r, i) {
              let s = e.getIterator(),
        ...
        createRange(e, t, n) {
          n = n
            .sort((e, t) => iP(e, t))
            .filter((e, t, n) => !t || 0 !== iP(e, n[t - 1]));
          let r = [];
          for (let i of (r.push(e), n)) {
            let n = iP(i, e),
              s = iP(i, t);
            if (0 === n) r[0] = e.Rn();
            else if (n > 0 && s < 0) (r.push(i), r.push(i.Rn()));
            else if (s > 0) break;
          }
          r.push(t);
          let i = [];
          for (let e = 0; e < r.length; e += 2) {
            ...
            let t = r[e].mn(this.uid, iJ, J.empty()),
              n = r[e + 1].mn(this.uid, iJ, J.empty());
        ...
        getMinOffsetFromCollectionGroup(e, t) {
          return this.getFieldIndexes(e, t).next(i0);
        }
        getMinOffset(e, t) {
          return ec
            .mapArray(this.xn(t), (t) =>
              this.On(e, t).next((e) => e || _(44426)),
            )
            .next(i0);
        }
      }
      function i0(e) {
        ...
        return new ea(t.readTime, t.documentKey, n);
      }
      let i1 = {
        didRun: !1,
      ...
      class i2 {
        static withCacheSize(e) {
          return new i2(
            e,
            i2.DEFAULT_COLLECTION_PERCENTILE,
            i2.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
          );
        }
        constructor(e, t, n) {
      ...
      function i5(e, t, n) {
        let r = e.store(eF),
          ...
          o = 0,
          l = r.te({ range: a }, (e, t, n) => (o++, n.delete()));
        s.push(
          l.next(() => {
            C(1 === o, 47070, { batchId: n.batchId });
          }),
        );
        let u = [];
        for (let e of n.mutations) {
          var h, c;
          let r = ((h = e.key.path), (c = n.batchId), [t, ek(h), c]);
          (s.push(i.delete(r)), u.push(e.key));
        }
        return ec.waitFor(s).next(() => u);
      }
      function i4(e) {
        let t;
        if (!e) return 0;
        if (e.document) t = e.document;
          ...
          if (!e.noDocument) throw _(14731);
          t = e.noDocument;
        }
        return JSON.stringify(t).length;
      }
      ((i2.DEFAULT_COLLECTION_PERCENTILE = 10),
        (i2.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
        (i2.DEFAULT = new i2(
          0x2800000,
          i2.DEFAULT_COLLECTION_PERCENTILE,
          i2.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
        )),
        (i2.DISABLED = new i2(-1, 0, 0)));
      class i3 {
        constructor(e, t, n, r) {
          ((this.userId = e),
            (this.serializer = t),
        ...
        static bt(e, t, n, r) {
          return (
            C("" !== e.uid, 64387),
            new i3(e.isAuthenticated() ? e.uid : "", t, n, r)
          );
        }
        checkEmpty(e) {
          let t = !0,
        ...
        addMutationBatch(e, t, n, r) {
          let i = tb(e, eB),
            s = i8(e);
          return s.add({}).next((a) => {
            C("number" == typeof a, 49019);
            let o = new rk(a, t, n, r),
              l = (function (e, t, n) {
                let r = n.baseMutations.map((t) => ia(e.wt, t)),
                  i = n.mutations.map((t) => ia(e.wt, t));
                return {
                  userId: t,
                  batchId: n.batchId,
              ...
              u = [],
              h = new tk((e, t) => B(e.canonicalString(), t.canonicalString()));
            for (let e of r) {
              var c, d;
              let t = ((c = this.userId), (d = e.key.path), [c, ek(d), a]);
            ...
            .next((e) =>
              e
                ? (C(
                    ...
                    { userId: e.userId, batchId: t },
                  ),
                  iT(this.serializer, e))
                : null,
            );
        }
        tr(e, t) {
          return this.er[t]
            ? ec.resolve(this.er[t])
        ...
        getNextMutationBatchAfterBatchId(e, t) {
          let n = t + 1,
            ...
            i = null;
          return i8(e)
            .te({ index: eP, range: r }, (e, t, r) => {
              (t.userId === this.userId &&
                (C(t.batchId >= n, 47524, { nr: n }),
                (i = iT(this.serializer, t))),
                r.done());
            })
            .next(() => i);
        }
        getHighestUnacknowledgedBatchId(e) {
          let t = IDBKeyRange.upperBound([
            ...
            n = -1;
          return i8(e)
            .te({ index: eP, range: t, reverse: !0 }, (e, t, r) => {
              ((n = t.batchId), r.done());
            })
            .next(() => n);
        }
        getAllMutationBatches(e) {
          let t = IDBKeyRange.bound(
            [this.userId, -1],
            [this.userId, Number.POSITIVE_INFINITY],
          );
          return i8(e)
            .J(eP, t)
            .next((e) => e.map((e) => iT(this.serializer, e)));
        }
        getAllMutationBatchesAffectingDocumentKey(e, t) {
          let n = [this.userId, ek(t.path)],
            ...
            .te({ range: r }, (n, r, s) => {
              ...
              if (a === this.userId && t.path.isEqual(u))
                return i8(e)
                  .get(l)
                  .next((e) => {
                    if (!e) throw _(61480, { rr: n, batchId: l });
                    (C(
                      e.userId === this.userId,
                      10503,
                      "Unexpected user for mutation batch",
                      { userId: e.userId, batchId: l },
                    ),
                      i.push(iT(this.serializer, e)));
                  });
              s.done();
            })
            .next(() => i);
        ...
        getAllMutationBatchesAffectingDocumentKeys(e, t) {
          ...
          return (
            t.forEach((t) => {
              let i = [this.userId, ek(t.path)],
                s = IDBKeyRange.lowerBound(i),
                a = tb(e, eB).te({ range: s }, (e, r, i) => {
                  let [s, a, o] = e,
                    l = eA(a);
            ...
            t.forEach((t) => {
              r.push(
                i8(e)
                  .get(t)
                  .next((e) => {
                    if (null === e) throw _(35274, { batchId: t });
                    (C(
                      e.userId === this.userId,
                      9748,
                      "Unexpected user for mutation batch",
        ...
        removeMutationBatch(e, t) {
          return i5(e.he, this.userId, t).next(
            (n) => (
              e.addOnCommittedListener(() => {
                this.sr(t.batchId);
              }),
      ...
      class i7 {
        ...
        allocateTargetId(e) {
          return this.hr(e).next((t) => {
            let n = new i9(t.highestTargetId);
            return (
        ...
        removeTargetData(e, t) {
          return this.removeMatchingKeysForTargetId(e, t.targetId)
            .next(() => tb(e, eW).delete(t.targetId))
            .next(() => this.hr(e))
            .next(
              (t) => (
                C(t.targetCount > 0, 8065),
                (t.targetCount -= 1),
                this.Pr(e, t)
              ),
            );
        ...
        hr(e) {
          return tb(e, e4)
            .get(e5)
            .next((e) => (C(null !== e, 2888), e));
        }
        Pr(e, t) {
          return tb(e, e4).put(e5, t);
        }
        Tr(e, t) {
          return tb(e, eW).put(ib(this.serializer, t));
        }
        Ir(e, t) {
          let n = !1;
          return (
        ...
        getTargetData(e, t) {
          let n = nM(t),
            ...
            i = null;
          return tb(e, eW)
            .te({ range: r, index: eX }, (e, n, r) => {
              let s = iE(n);
              nF(t, s.target) && ((i = s), r.done());
            })
            .next(() => i);
        }
        ...
        containsKey(e, t) {
          let n = ek(t.path),
            ...
            i = 0;
          return se(e)
            .te({ index: e1, ee: !0, range: r }, ([e, t], n, r) => {
              0 !== e && (i++, r.done());
            })
            .next(() => i > 0);
        }
      ...
      class sr {
        constructor(e) {
          ((this.Er = e), (this.buffer = new tk(sn)), (this.dr = 0));
        }
        Ar() {
          return ++this.dr;
        }
        Rr(e) {
          ...
          if (this.buffer.size < this.Er) this.buffer = this.buffer.add(t);
            ...
            0 > sn(t, e) && (this.buffer = this.buffer.delete(e).add(t));
          }
        }
        get maxValue() {
      ...
      class si {
        ...
        mr(e) {
          (T(st, `Garbage collection scheduled in ${e}ms`),
      ...
      class ss {
        ...
        nthSequenceNumber(e, t) {
          if (0 === t) return ec.resolve(eS.le);
          let n = new sr(t);
          return this.gr
            .forEachTarget(e, (e) => n.Rr(e.sequenceNumber))
            .next(() => this.gr.yr(e, (e) => n.Rr(e)))
            .next(() => n.maxValue);
        }
        removeTargets(e, t, n) {
        ...
        collect(e, t) {
          return -1 === this.params.cacheSizeCollectionThreshold
            ? (T("LruGarbageCollector", "Garbage collection skipped; disabled"),
              ec.resolve(i1))
	...
	Determined least recently used ${r} in ` +
      ...
      class sa {
        constructor(e, t) {
          ((this.db = e), (this.garbageCollector = new ss(this, t)));
        }
        pr(e) {
          let t = this.br(e);
          return this.db
        ...
        Dr(e, t) {
          ...
          return (
            ...
            tb(e, eM)
              .ne((r) =>
                i6(e, r, t).next((e) => (e && (n = !0), ec.resolve(!e))),
              )
              .next(() => n)
          );
        }
        removeOrphanedDocuments(e, t) {
          let n = this.db.getRemoteDocumentCache().newChangeBuffer(),
            r = [],
            i = 0;
          return this.Sr(e, (s, a) => {
            if (a <= t) {
              let t = this.Dr(e, s).next((t) => {
                if (!t)
                  return (
                    i++,
                    n
                      ...
                      .next(
                        () => (
                          n.removeEntry(s, j.min()),
                          se(e).delete([0, ek(s.path)])
                        ),
                      )
                  );
              });
        ...
        Sr(e, t) {
          let n = se(e),
            ...
            i = eS.le;
          return n
            .te({ index: e1 }, ([e, n], { path: s, sequenceNumber: a }) => {
              0 === e
                ? (i !== eS.le && t(new J(eA(r)), i), (i = a), (r = s))
                : (i = eS.le);
            })
            .next(() => {
              i !== eS.le && t(new J(eA(r)), i);
            });
        }
        getCacheSize(e) {
      ...
      function so(e, t) {
        ...
        return se(e).put(
          ...
          { targetId: 0, path: ek(t.path), sequenceNumber: n }),
        );
      }
      class sl {
        constructor() {
        ...
        removeEntry(e, t) {
          (this.assertNotApplied(),
            this.changes.set(e, nd.newInvalidDocument(e).setReadTime(t)));
        }
        getEntry(e, t) {
          this.assertNotApplied();
          let n = this.changes.get(t);
          return void 0 !== n ? ec.resolve(n) : this.getFromCache(e, t);
        }
        getEntries(e, t) {
      ...
      class su {
        ...
        addEntry(e, t, n) {
          return tb(e, ez).put(n);
        }
        removeEntry(e, t, n) {
          return tb(e, ez).delete(
            (function (e, t) {
        ...
        updateMetadata(e, t) {
          return this.getMetadata(e).next(
            (n) => ((n.byteSize += t), this.vr(e, n)),
          );
        }
        getEntry(e, t) {
          let n = nd.newInvalidDocument(t);
          return tb(e, ez)
            .te({ index: eK, range: IDBKeyRange.only(sc(t)) }, (e, r) => {
              n = this.Cr(t, r);
            })
            .next(() => n);
        }
        Fr(e, t) {
          let n = { size: 0, document: nd.newInvalidDocument(t) };
          return tb(e, ez)
            .te({ index: eK, range: IDBKeyRange.only(sc(t)) }, (e, r) => {
              n = { document: this.Cr(t, r), size: i4(r) };
            })
            .next(() => n);
        }
        getEntries(e, t) {
        ...
        Or(e, t) {
          let n = n5,
            r = new tC(J.comparator);
          return this.Mr(e, t, (e, t) => {
            let i = this.Cr(e, t);
            ((n = n.insert(e, i)), (r = r.insert(e, i4(t))));
          }).next(() => ({ documents: n, Nr: r }));
        }
        Mr(e, t, n) {
          if (t.isEmpty()) return ec.resolve();
          let r = new tk(sf);
          t.forEach((e) => (r = r.add(e)));
          let i = IDBKeyRange.bound(sc(r.first()), sc(r.last())),
            s = r.getIterator(),
            a = s.getNext();
          return tb(e, ez)
            .te({ index: eK, range: i }, (e, t, r) => {
              let i = J.fromSegments([
                ...t.prefixPath,
                t.collectionGroup,
                t.documentId,
              ]);
              for (; a && 0 > sf(a, i); ) (n(a, null), (a = s.getNext()));
              (a &&
                a.isEqual(i) &&
        ...
        getAllFromCollectionGroup(e, t, n, r) {
          ...
          return tb(e, ez)
            .te(
              { index: ej, range: IDBKeyRange.bound(s, a, !0) },
              (e, t, n) => {
                let s = this.Cr(
                  J.fromSegments(
        ...
        newChangeBuffer(e) {
          return new sh(this, !!e && e.trackRemovals);
        }
        getSize(e) {
        ...
        Cr(e, t) {
          if (t) {
            let e = (function (e, t) {
              let n;
              if (t.document)
                n = is(e.wt, t.document, !!t.hasCommittedMutations);
              else if (t.noDocument) {
                let e = J.fromSegments(t.noDocument.path),
                  r = iI(t.noDocument.readTime);
                ((n = nd.newNoDocument(e, r)),
                  t.hasCommittedMutations && n.setHasCommittedMutations());
              } else {
                if (!t.unknownDocument) return _(56709);
                {
                  let e = J.fromSegments(t.unknownDocument.path),
                    r = iI(t.unknownDocument.version);
                  n = nd.newUnknownDocument(e, r);
                }
              }
              return (
                t.readTime &&
            ...
            if (!(e.isNoDocument() && e.version.isEqual(j.min()))) return e;
          }
          return nd.newInvalidDocument(e);
        }
      }
      class sh extends sl {
        constructor(e, t) {
        ...
        applyChanges(e) {
          let t = [],
            n = 0,
            r = new tk((e, t) => B(e.canonicalString(), t.canonicalString()));
          return (
            this.changes.forEach((i, s) => {
              let a = this.Lr.get(i);
              if (
                (t.push(this.Br.removeEntry(e, i, a.readTime)),
                s.isValidDocument())
              ) {
                let o = iy(this.Br.serializer, s);
                r = r.add(i.path.popLast());
                let l = i4(o);
                ((n += l - a.size), t.push(this.Br.addEntry(e, i, o)));
              } else if (((n -= a.size), this.trackRemovals)) {
                let n = iy(this.Br.serializer, s.convertToNoDocument(j.min()));
      ...
      function sf(e, t) {
        ...
        for (let e = 0; e < n.length - 2 && e < r.length - 2; ++e)
          if ((i = B(n[e], r[e]))) return i;
        return (
          (i = B(n.length, r.length)) ||
          (i = B(n[n.length - 2], r[r.length - 2])) ||
          B(n[n.length - 1], r[r.length - 1])
        );
      }
      class sm {
        constructor(e, t) {
      ...
      class sg {
        ...
        getDocument(e, t) {
          ...
          return this.documentOverlayCache
            ...
            .next(
              (e) => (null !== n && rT(n.mutation, e, tR.empty(), G.now()), e),
            );
        }
        getDocuments(e, t) {
          return this.remoteDocumentCache
            .getEntries(e, t)
            .next((t) =>
              this.getLocalViewOfDocuments(e, t, re()).next(() => t),
            );
        }
        getLocalViewOfDocuments(e, t, n = re()) {
          let r = n8();
        ...
        computeViews(e, t, n, r) {
          ...
          return (
            t.forEach((e, t) => {
              let a = n.get(t.key);
              r.has(t.key) && (void 0 === a || a.mutation instanceof rx)
                ? (i = i.insert(t.key, t))
                : void 0 !== a
                  ? (s.set(t.key, a.mutation.getFieldMask()),
                    rT(a.mutation, t, a.mutation.getFieldMask(), G.now()))
                  : s.set(t.key, tR.empty());
            }),
            this.recalculateAndSaveOverlays(e, i).next(
              (e) => (
                ...
                t.forEach((e, t) => {
                  var n;
                  return a.set(e, new sm(t, null != (n = s.get(e)) ? n : null));
                }),
                a
              ),
            )
            ...
            .next((e) => {
              for (let i of e)
                i.keys().forEach((e) => {
                  let s = t.get(e);
                  if (null === s) return;
                  let a = n.get(e) || tR.empty();
                  ((a = i.applyToLocalView(s, a)), n.set(e, a));
                  let o = (r.get(i.batchId) || re()).add(e);
            ...
            .next((i) => {
              ...
              return s.next((t) =>
                ec
                  ...
                  .next(() => this.computeViews(e, o, t, re()))
                  .next((e) => ({ batchId: a, changes: n6(e) })),
              );
            });
        }
        getDocumentsMatchingDocumentQuery(e, t) {
          return this.getDocument(e, new J(t)).next((e) => {
            let t = n3();
          ...
          return this.documentOverlayCache
            ...
            .next((e) => {
              i.forEach((t, n) => {
                let r = n.getKey();
                null === e.get(r) &&
                  (e = e.insert(r, nd.newInvalidDocument(r)));
              });
              let n = n3();
              return (
                e.forEach((e, r) => {
                  let s = i.get(e);
                  (void 0 !== s && rT(s.mutation, r, tR.empty(), G.now()),
                    nZ(t, r) && (n = n.insert(e, r)));
                }),
                n
              );
            });
      ...
      class sp {
        ...
        getBundleMetadata(e, t) {
          return ec.resolve(this.kr.get(t));
        }
        saveBundleMetadata(e, t) {
          return (
            this.kr.set(t.id, {
              id: t.id,
              version: t.version,
              createTime: r5(t.createTime),
            }),
            ec.resolve()
          );
        }
        getNamedQuery(e, t) {
          return ec.resolve(this.qr.get(t));
        }
        saveNamedQuery(e, t) {
          return (
            this.qr.set(t.name, {
              name: t.name,
              query: ix(t.bundledQuery),
              readTime: r5(t.readTime),
            }),
            ec.resolve()
          );
        }
      ...
      class sy {
        constructor() {
          ((this.overlays = new tC(J.comparator)), (this.Qr = new Map()));
        }
        getOverlay(e, t) {
        ...
        getOverlaysForCollectionGroup(e, t, n, r) {
          ...
          for (; s.hasNext(); ) {
            ...
            if (e.getKey().getCollectionGroup() === t && e.largestBatchId > n) {
              ...
              (null === t && ((t = n8()), (i = i.insert(e.largestBatchId, t))),
                t.set(e.getKey(), e));
            }
          }
          let a = n8(),
        ...
        St(e, t, n) {
          ...
          if (null !== r) {
            let e = this.Qr.get(r.largestBatchId).delete(n.key);
            this.Qr.set(r.largestBatchId, e);
          }
          this.overlays = this.overlays.insert(n.key, new rV(t, n));
          let i = this.Qr.get(t);
          (void 0 === i && ((i = re()), this.Qr.set(t, i)),
            this.Qr.set(t, i.add(n.key)));
        }
      }
      class sw {
        constructor() {
          this.sessionToken = tM.EMPTY_BYTE_STRING;
        }
        getSessionToken(e) {
      ...
      class sv {
        constructor() {
          ((this.$r = new tk(sI.Ur)), (this.Kr = new tk(sI.Wr)));
        }
        isEmpty() {
      ...
      class sI {
        ...
        static Ur(e, t) {
          return J.comparator(e.key, t.key) || B(e.Zr, t.Zr);
        }
        static Wr(e, t) {
          return B(e.Zr, t.Zr) || J.comparator(e.key, t.key);
        }
      }
      class sT {
        constructor(e, t) {
        ...
        addMutationBatch(e, t, n, r) {
          ...
          let s = new rk(i, t, n, r);
          for (let t of (this.mutationQueue.push(s), r))
            ((this.Xr = this.Xr.add(new sI(t.key, i))),
        ...
        getHighestUnacknowledgedBatchId() {
          return ec.resolve(0 === this.mutationQueue.length ? -1 : this.nr - 1);
        }
        getAllMutationBatches(e) {
        ...
        getAllMutationBatchesAffectingDocumentKey(e, t) {
          let n = new sI(t, 0),
            r = new sI(t, Number.POSITIVE_INFINITY),
            i = [];
          return (
            this.Xr.forEachInRange([n, r], (e) => {
              let t = this.ei(e.Zr);
              i.push(t);
            }),
            ec.resolve(i)
        ...
        getAllMutationBatchesAffectingDocumentKeys(e, t) {
          ...
          return (
            t.forEach((e) => {
              let t = new sI(e, 0),
                r = new sI(e, Number.POSITIVE_INFINITY);
              this.Xr.forEachInRange([t, r], (e) => {
                n = n.add(e.Zr);
              });
            }),
            ec.resolve(this.ni(n))
          );
        }
        getAllMutationBatchesAffectingQuery(e, t) {
          let n = t.path,
          ...
          let s = new sI(new J(i), 0),
            a = new tk(B);
          return (
            this.Xr.forEachWhile((e) => {
              let t = e.key.path;
              return (
                !!n.isPrefixOf(t) && (t.length === r && (a = a.add(e.Zr)), !0)
              );
            }, s),
            ec.resolve(this.ni(a))
          );
        }
        ni(e) {
          let t = [];
        ...
        removeMutationBatch(e, t) {
          (C(0 === this.ri(t.batchId, "removed"), 55003),
            this.mutationQueue.shift());
          let n = this.Xr;
          return ec
            .forEach(t.mutations, (r) => {
              let i = new sI(r.key, t.batchId);
              return (
                (n = n.delete(i)),
        ...
        containsKey(e, t) {
          ...
          return ec.resolve(t.isEqual(r && r.key));
        }
        performConsistencyCheck(e) {
      ...
      class sE {
        constructor(e) {
          ((this.ii = e), (this.docs = new tC(J.comparator)), (this.size = 0));
        }
        setIndexManager(e) {
          this.indexManager = e;
        }
        ...
        getEntry(e, t) {
          ...
          return ec.resolve(
            n ? n.document.mutableCopy() : nd.newInvalidDocument(t),
          );
        }
        getEntries(e, t) {
          let n = n5;
          return (
            t.forEach((e) => {
              ...
              n = n.insert(
                e,
                t ? t.document.mutableCopy() : nd.newInvalidDocument(e),
              );
            }),
            ec.resolve(n)
          );
        ...
        getDocumentsMatchingQuery(e, t, n, r) {
          let i = n5,
            s = t.path,
            a = new J(s.child("__id-9223372036854775808__")),
      ...
      class sx {
        ...
        forEachTarget(e, t) {
          return (this.oi.forEach((e, n) => t(n)), ec.resolve());
        }
        getLastRemoteSnapshotVersion(e) {
          return ec.resolve(this.lastRemoteSnapshotVersion);
        }
        getHighestSequenceNumber(e) {
          return ec.resolve(this._i);
        }
        allocateTargetId(e) {
          return (
        ...
        Tr(e) {
          ...
          (t > this.highestTargetId &&
            ((this.ui = new i9(t)), (this.highestTargetId = t)),
            e.sequenceNumber > this._i && (this._i = e.sequenceNumber));
        }
        addTargetData(e, t) {
          return (this.Tr(t), (this.targetCount += 1), ec.resolve());
        }
        updateTargetData(e, t) {
          return (this.Tr(t), ec.resolve());
        }
        removeTargetData(e, t) {
          return (
        ...
        getTargetData(e, t) {
          let n = this.oi.get(t) || null;
          return ec.resolve(n);
        }
        addMatchingKeys(e, t, n) {
          return (this.ai.Gr(t, n), ec.resolve());
        }
        removeMatchingKeys(e, t, n) {
          this.ai.jr(t, n);
        ...
        removeMatchingKeysForTargetId(e, t) {
          return (this.ai.Hr(t), ec.resolve());
        }
        getMatchingKeysForTargetId(e, t) {
          let n = this.ai.Yr(t);
          return ec.resolve(n);
        ...
        containsKey(e, t) {
          return ec.resolve(this.ai.containsKey(t));
        }
      }
      class s_ {
        constructor(e, t) {
          ((this.ci = {}),
            ...
            (this.Ti = new sx(this)),
            (this.indexManager = new iH()),
            (this.remoteDocumentCache = new sE((e) =>
              this.referenceDelegate.Ii(e),
            )),
            (this.serializer = new ip(t)),
            (this.Ei = new sp(this.serializer)));
        }
        start() {
        ...
        getDocumentOverlayCache(e) {
          ...
          return (t || ((t = new sy()), (this.overlays[e.toKey()] = t)), t);
        }
        getMutationQueue(e, t) {
          let n = this.ci[e.toKey()];
          return (
            n ||
              ((n = new sT(t, this.referenceDelegate)),
              (this.ci[e.toKey()] = n)),
            n
          );
        }
        ...
        runTransaction(e, t, n) {
          ...
          let r = new sS(this.li.next());
          return (
            this.referenceDelegate.di(),
            n(r)
              .next((e) => this.referenceDelegate.Ai(r).next(() => e))
              .toPromise()
      ...
      class sC {
        constructor(e) {
          ((this.persistence = e), (this.Vi = new sv()), (this.mi = null));
        }
        static fi(e) {
          return new sC(e);
        }
        ...
        markPotentiallyOrphaned(e, t) {
          return (this.gi.add(t.toString()), ec.resolve());
        }
        removeTarget(e, t) {
        ...
        pi(e, t) {
          return ec.or([
            () => ec.resolve(this.Vi.containsKey(t)),
      ...
      class sN {
        constructor(e, t) {
          ((this.persistence = e),
            ...
            (this.garbageCollector = new ss(this, t)));
        }
        static fi(e, t) {
          return new sN(e, t);
        }
        ...
        yr(e, t) {
          return ec.forEach(this.yi, (n, r) =>
            this.Dr(e, n, r).next((e) => (e ? ec.resolve() : t(r))),
          );
        }
        removeTargets(e, t, n) {
        ...
        removeOrphanedDocuments(e, t) {
          ...
          return r
            .si(e, (r) =>
              this.Dr(e, r, t).next((e) => {
                e || (n++, i.removeEntry(r, j.min()));
              }),
            )
            .next(() => i.apply(e))
            .next(() => n);
        ...
        markPotentiallyOrphaned(e, t) {
          return (this.yi.set(t, e.currentSequenceNumber), ec.resolve());
        }
        removeTarget(e, t) {
          let n = t.withSequenceNumber(e.currentSequenceNumber);
        ...
        addReference(e, t, n) {
          return (this.yi.set(n, e.currentSequenceNumber), ec.resolve());
        }
        removeReference(e, t, n) {
          return (this.yi.set(n, e.currentSequenceNumber), ec.resolve());
        }
            ...
            e.isFoundDocument() &&
              (t += (function e(t) {
                switch (t2(t)) {
                  ...
                  case 6:
                    return tU(t.bytesValue).approximateByteSize();
                  case 7:
        ...
        Dr(e, t, n) {
          return ec.or([
            ...
            () => {
              let e = this.yi.get(t);
              return ec.resolve(void 0 !== e && e > n);
            },
          ]);
        }
        getCacheSize(e) {
      ...
      class sD {
        ...
        q(e, t, n, r) {
          let i = new ef("createOrUpgrade", t);
          n < 1 &&
            r >= 1 &&
            (e.createObjectStore(eR),
            e.createObjectStore(eM, { keyPath: "userId" }),
            e
              .createObjectStore(eF, { keyPath: eL, autoIncrement: !0 })
              .createIndex(eP, eU, { unique: !0 }),
            e.createObjectStore(eB),
            sk(e),
            e.createObjectStore(eV));
          let s = ec.resolve();
          return (
            n < 3 &&
              r >= 3 &&
              (0 !== n &&
                (e.deleteObjectStore(eZ),
                e.deleteObjectStore(eW),
                e.deleteObjectStore(e4),
                sk(e)),
              (s = s.next(() =>
                (function (e) {
                  let t = e.store(e4),
                    n = {
                      ...
                      lastRemoteSnapshotVersion: j.min().toTimestamp(),
                      targetCount: 0,
                    };
                  return t.put(e5, n);
                })(i),
            ...
            n < 4 &&
              ...
              (0 !== n &&
                (s = s.next(() =>
                  i
                    ...
                    .J()
                    .next((t) => {
                      (e.deleteObjectStore(eF),
                        e
                          .createObjectStore(eF, {
                            keyPath: eL,
                            autoIncrement: !0,
                          })
                          .createIndex(eP, eU, { unique: !0 }));
              ...
              (s = s.next(() => {
                e.createObjectStore(e8, { keyPath: "clientId" });
              }))),
            n < 5 && r >= 5 && (s = s.next(() => this.wi(i))),
            n < 6 &&
              r >= 6 &&
              (s = s.next(() => (e.createObjectStore(eY), this.bi(i)))),
            n < 7 && r >= 7 && (s = s.next(() => this.Si(i))),
            ...
            n < 11 &&
              r >= 11 &&
              (s = s.next(() => {
                (e.createObjectStore(e9, { keyPath: "bundleId" }),
                  e.createObjectStore(e7, { keyPath: "name" }));
              })),
            n < 12 &&
              r >= 12 &&
              (s = s.next(() => {
                let t = e.createObjectStore(th, { keyPath: tc });
                (t.createIndex(td, tf, { unique: !1 }),
                  t.createIndex(tm, tg, { unique: !1 }));
              })),
            n < 13 &&
              r >= 13 &&
              (s = s
                .next(() =>
                  (function (e) {
                    let t = e.createObjectStore(ez, { keyPath: e$ });
                    (t.createIndex(eK, eG), t.createIndex(ej, eQ));
                  })(e),
                )
                .next(() => this.Fi(e, i))
                .next(() => e.deleteObjectStore(eV))),
            n < 14 && r >= 14 && (s = s.next(() => this.Mi(e, i))),
            n < 15 &&
              r >= 15 &&
              (s = s.next(() => {
                (e
                  .createObjectStore(te, {
                    keyPath: "indexId",
                    autoIncrement: !0,
                  })
                  .createIndex(tt, "collectionGroup", { unique: !1 }),
                  e
                    .createObjectStore(tn, { keyPath: tr })
                    .createIndex(ti, ts, { unique: !1 }),
                  e
                    .createObjectStore(ta, { keyPath: to })
                    .createIndex(tl, tu, { unique: !1 }));
              })),
            n < 16 &&
              r >= 16 &&
              (s = s
                .next(() => {
                  t.objectStore(tn).clear();
                })
                .next(() => {
                  t.objectStore(ta).clear();
                })),
            n < 17 &&
              r >= 17 &&
              (s = s.next(() => {
                e.createObjectStore(tp, { keyPath: "name" });
              })),
            n < 18 &&
              r >= 18 &&
              (0, h.Ov)() &&
            ...
            ec.forEach(t, (t) => {
              ...
              return n.J(eP, r).next((n) =>
                ec.forEach(n, (n) => {
                  ...
                  let r = iT(this.serializer, n);
                  return i5(e, t.userId, r).next(() => {});
                }),
              );
            }),
          );
        ...
        Di(e, t) {
          e.createObjectStore(e3, { keyPath: e6 });
          let n = t.store(e3),
            r = new iW(),
            i = (e) => {
              if (r.add(e)) {
                let t = e.lastSegment(),
                  r = e.popLast();
                return n.put({ collectionId: t, parent: ek(r) });
              }
            };
          return t
            .store(eV)
            .te({ ee: !0 }, (e, t) => i(new H(e).popLast()))
            .next(() =>
              t.store(eB).te({ ee: !0 }, ([e, t, n], r) => i(eA(t).popLast())),
            );
        }
        Ci(e) {
          let t = e.store(eW);
          ...
          return n
            .te((e, n) => {
              let i = t.store(ez),
                s = (
                  n.document
                    ? new J(H.fromString(n.document.name).popFirst(5))
                    : n.noDocument
                      ? J.fromSegments(n.noDocument.path)
                      : n.unknownDocument
                        ? J.fromSegments(n.unknownDocument.path)
                        : _(36783)
                ).path.toArray(),
                a = {
        ...
        Mi(e, t) {
          let n = t.store(eF),
            r = new su(this.serializer),
            i = new s_(sC.fi, this.serializer.wt);
          return n.J().next((e) => {
            let n = new Map();
            return (
              e.forEach((e) => {
                var t;
                let r = null != (t = n.get(e.userId)) ? t : re();
                (iT(this.serializer, e)
                  .keys()
                  .forEach((e) => (r = r.add(e))),
                  n.set(e.userId, r));
              ...
              ec.forEach(n, (e, n) => {
                let s = new y(n),
                  a = iD.bt(this.serializer, s),
                  o = i.getIndexManager(s);
                return new sg(
                  r,
                  i3.bt(s, this.serializer, o, i.referenceDelegate),
                  a,
                  o,
                )
      ...
      function sk(e) {
        (e
          .createObjectStore(eZ, { keyPath: e0 })
          .createIndex(e1, e2, { unique: !0 }),
          e
            .createObjectStore(eW, { keyPath: "targetId" })
            .createIndex(eX, eJ, { unique: !0 }),
          e.createObjectStore(e4));
      }
      let sA = "IndexedDbPersistence",
        sV =
      ...
      class sR {
        constructor(e, t, n, r, i, s, a, o, l, u, h = 18) {
          if (
          ...
          ((this.referenceDelegate = new sa(this, r)),
            (this.Ui = t + "main"),
            (this.serializer = new ip(o)),
            (this.Ki = new em(this.Ui, this.Bi, new sD(this.serializer))),
            (this.Pi = new ik()),
            (this.Ti = new i7(this.referenceDelegate, this.serializer)),
            (this.remoteDocumentCache = new su(this.serializer)),
            (this.Ei = new iN()),
          ...
          return this.Gi()
            .then(() => {
              if (!this.isPrimary && !this.allowTabSynchronization)
                throw new D(N.FAILED_PRECONDITION, sV);
              return (
                this.zi(),
                this.ji(),
                this.Hi(),
          ...
          return this.runTransaction(
            ...
            (e) =>
              tb(e, e8)
                ...
                .next(() => {
                  if (this.isPrimary)
                    return this.Yi(e).next((e) => {
                      e ||
                        ((this.isPrimary = !1),
                        this.xi.enqueueRetryable(() => this.$i(!1)));
                    });
                })
                .next(() => this.Zi(e))
                .next((t) =>
            ...
            .catch((e) => {
              if (ew(e))
                return (
                  T(sA, "Failed to extend owner lease: ", e),
                  this.isPrimary
                );
            ...
            .then((e) => {
              (this.isPrimary !== e &&
                this.xi.enqueueRetryable(() => this.$i(e)),
                (this.isPrimary = e));
            });
        }
        Yi(e) {
          return tb(e, eR)
            .get(eO)
            .next((e) => ec.resolve(this.ts(e)));
        }
        ns(e) {
          return tb(e, e8).delete(this.clientId);
        }
        async rs() {
          if (this.isPrimary && !this.ss(this.Qi, 18e5)) {
            this.Qi = Date.now();
            ...
            if (this.Wi)
              for (let t of e) this.Wi.removeItem(this.us(t.clientId));
          }
        }
        Hi() {
          this.qi = this.xi.enqueueAfterDelay(
        ...
        async shutdown() {
          ((this.hi = !1),
            ...
            this.hs(),
            this.Ps(),
            await this.Ki.runTransaction(
              "shutdown",
              "readwrite",
              [eR, e8],
              (e) => {
                let t = new tE(e, eS.le);
        ...
        _s(e, t) {
          return e.filter(
            (e) => this.ss(e.updateTimeMs, t) && !this.cs(e.clientId),
          );
        }
        Is() {
          return this.runTransaction("getActiveClients", "readonly", (e) =>
            tb(e, e8)
              .J()
              .next((e) => this._s(e, 18e5).map((e) => e.clientId)),
          );
        }
        get started() {
          return this.hi;
        ...
        getMutationQueue(e, t) {
          return i3.bt(e, this.serializer, t, this.referenceDelegate);
        }
        getTargetCache() {
          return this.Ti;
        }
        ...
        getIndexManager(e) {
          return new iZ(e, this.serializer.wt.databaseId);
        }
        getDocumentOverlayCache(e) {
          return iD.bt(this.serializer, e);
        }
        getBundleCache() {
          return this.Ei;
        }
        runTransaction(e, t, n) {
          ...
          return this.Ki.runTransaction(
            ...
            s,
            (r) => (
              (i = new tE(r, this.li ? this.li.next() : eS.le)),
              "readwrite-primary" === t
                ? this.Yi(i)
                    .next((e) => !!e || this.Zi(i))
                    .next((t) => {
                      if (!t)
                        throw (
                          ...
                          (this.isPrimary = !1),
                          this.xi.enqueueRetryable(() => this.$i(!1)),
                          new D(N.FAILED_PRECONDITION, el)
                        );
                      return n(i);
                    })
                    .next((e) => this.es(i).next(() => e))
                : this.Es(i).next(() => n(i))
            ),
        ...
        Xi(e) {
          ...
          return t
            ...
            .next((e) =>
              this.ts(e)
                ? (T(sA, "Releasing primary lease."), t.delete(eO))
                : ec.resolve(),
            );
        }
        ss(e, t) {
          ...
          return (
            !(e < n - t) &&
            (!(e > n) ||
              (E(`Detected an update time that is in the future: ${e} > ${n}`),
              !1))
          );
        }
        zi() {
        ...
        Ps() {
          this.Li &&
            (this.window.removeEventListener("pagehide", this.Li),
            (this.Li = null));
        }
        cs(e) {
          var t;
          try {
            let n =
              null !== (null == (t = this.Wi) ? void 0 : t.getItem(this.us(e)));
            return (
              T(
                sA,
            ...
            return (E(sA, "Failed to get zombied client id.", e), !1);
          }
        }
        ls() {
          if (this.Wi)
            try {
              ...
              E("Failed to set zombie client id.", e);
            }
        }
        Ts() {
          if (this.Wi)
      ...
      class sM {
        ...
        static Rs(e, t) {
          ...
          return new sM(e, t.fromCache, n, r);
        }
      }
      class sF {
        constructor() {
      ...
      class sL {
        constructor() {
          ((this.Vs = !1),
            (this.fs = !1),
            (this.gs = 100),
            (this.ps = (0, h.nr)() ? 8 : eg((0, h.ZQ)()) > 0 ? 6 : 4));
        }
        initialize(e, t) {
            ...
            : (I() <= u.$b.DEBUG &&
              ...
              n.documentReadCount > this.ps * r
                ? (I() <= u.$b.DEBUG &&
                  ...
                  this.indexManager.createTargetIndexes(e, nj(t)))
                : ec.resolve());
        }
        ws(e, t) {
          if (n$(t)) return ec.resolve(null);
          let n = nj(t);
            ...
            0 === r
              ...
              : (null !== t.limit &&
                ...
                this.indexManager.getDocumentsMatchingTarget(e, n).next((r) => {
                  let i = re(...r);
                  return this.ys.getDocuments(e, i).next((r) =>
                    this.indexManager.getMinOffset(e, n).next((n) => {
                      let s = this.vs(t, r);
                      return this.Cs(t, s, i, n.readTime)
                        ? this.ws(e, nH(t, null, "F"))
                        : this.Fs(e, s, t, n);
                    }),
                  );
                })),
        ...
        Ss(e, t, n) {
          return (
            ...
            this.ys.getDocumentsMatchingQuery(e, t, ea.min(), n)
          );
        }
        Fs(e, t, n, r) {
      ...
      function sB(e) {
        return e.persistence.runTransaction(
          ...
          "readonly",
          (t) => e.Ti.getLastRemoteSnapshotVersion(t),
        );
      }
      function sz(e, t, n) {
        let r = re(),
      ...
      function s$(e, t) {
        return e.persistence
          .runTransaction("Allocate target", "readwrite", (n) => {
            let r;
            return e.Ti.getTargetData(n, t).next((i) =>
              i
                ? ((r = i), ec.resolve(r))
                : e.Ti.allocateTargetId(n).next(
                    (i) => (
                      (r = new ig(
                        t,
                        i,
                      ...
                      e.Ti.addTargetData(n, r).next(() => r)
                    ),
                  ),
            );
          })
          .then((n) => {
            let r = e.xs.get(n.targetId);
            return (
              (null === r ||
                n.snapshotVersion.compareTo(r.snapshotVersion) > 0) &&
                ((e.xs = e.xs.insert(n.targetId, n)), e.Os.set(t, n.targetId)),
              n
            );
          });
      }
      async function sK(e, t, n) {
        ...
        try {
          ...
          if (!ew(e)) throw e;
          T(sP, `Failed to update sequence numbers for target ${t}: ${e}`);
        }
        ((e.xs = e.xs.remove(t)), e.Os.delete(r.target));
      }
      function sG(e, t, n) {
        let r = j.min(),
          i = re();
        return e.persistence.runTransaction("Execute query", "readwrite", (s) =>
          (function (e, t, n) {
            let r = e.Os.get(n);
            return void 0 !== r
              ? ec.resolve(e.xs.get(r))
              : e.Ti.getTargetData(t, n);
          })(e, s, nj(t))
            .next((t) => {
              if (t)
                return (
                  (r = t.lastLimboFreeSnapshotVersion),
                  e.Ti.getMatchingKeysForTargetId(s, t.targetId).next((e) => {
                    i = e;
                  })
                );
            })
            .next(() =>
              e.Ms.getDocumentsMatchingQuery(
                s,
                t,
                n ? r : j.min(),
                n ? i : re(),
            ...
            .next((n) => (sY(e, n0(t), n), { documents: n, $s: i })),
        );
      }
      function sj(e, t) {
        let n = e.Ti,
        ...
        return r
          ...
          : e.persistence.runTransaction("Get target data", "readonly", (e) =>
              n.Rt(e, t).next((e) => (e ? e.target : null)),
            );
      }
      function sQ(e, t) {
        let n = e.Ns.get(t) || j.min();
        return e.persistence
          .runTransaction("Get new document changes", "readonly", (r) =>
            e.Bs.getAllFromCollectionGroup(
              r,
              t,
              ei(n, -1),
              Number.MAX_SAFE_INTEGER,
      ...
      async function sH(e, t, n, r) {
        let i = re(),
          s = n5;
        for (let e of n) {
          let n = t.Us(e.metadata.name);
          e.document && (i = i.add(n));
          let r = t.Ks(e);
          (r.setReadTime(t.Ws(e.metadata.readTime)), (s = s.insert(n, r)));
        }
        let a = e.Bs.newChangeBuffer({ trackRemovals: !0 }),
          o = await s$(e, nj(nz(H.fromString(`__bundle__/docs/${r}`))));
        return e.persistence.runTransaction(
          ...
          (t) =>
            sz(t, a, s)
              .next((e) => (a.apply(t), e))
              .next((n) =>
                e.Ti.removeMatchingKeysForTargetId(t, o.targetId)
                  .next(() => e.Ti.addMatchingKeys(t, i, o.targetId))
                  .next(() =>
                    e.localDocuments.getLocalViewOfDocuments(t, n.qs, n.Qs),
                  )
                  .next(() => n.qs),
              ),
        );
      }
      async function sW(e, t, n = re()) {
        let r = await s$(e, nj(ix(t.bundledQuery)));
        return e.persistence.runTransaction(
          "Save named query",
          "readwrite",
          (i) => {
            ...
            if (r.snapshotVersion.compareTo(s) >= 0)
              return e.Ei.saveNamedQuery(i, t);
            let a = r.withResumeToken(tM.EMPTY_BYTE_STRING, s);
            return (
              (e.xs = e.xs.insert(a.targetId, a)),
              e.Ti.updateTargetData(i, a)
                .next(() => e.Ti.removeMatchingKeysForTargetId(i, r.targetId))
                .next(() => e.Ti.addMatchingKeys(i, n, r.targetId))
                .next(() => e.Ei.saveNamedQuery(i, t))
            );
          },
        );
      }
      let sX = "firestore_clients";
      function sJ(e, t) {
        return `${sX}_${e}_${t}`;
      }
      let sZ = "firestore_mutations";
      function s0(e, t, n) {
        let r = `${sZ}_${e}_${n}`;
        return (t.isAuthenticated() && (r += `_${t.uid}`), r);
      }
      let s1 = "firestore_targets";
      function s2(e, t) {
        return `${s1}_${e}_${t}`;
      }
      let s5 = "SharedClientState";
      class s4 {
        constructor(e, t, n, r) {
          ((this.user = e),
            (this.batchId = t),
        ...
        static Gs(e, t, n) {
          ...
          return (
            s &&
              ...
              (i = new D(r.error.code, r.error.message)),
            s
              ? new s4(e, t, r.state, i)
              : (E(s5, `Failed to parse mutation state for ID '${t}': ${n}`),
                null)
          );
        }
        zs() {
        ...
        static Gs(e, t) {
          ...
          return (
            i &&
              ...
              (r = new D(n.error.code, n.error.message)),
            i
              ? new s3(e, n.state, r)
              : (E(s5, `Failed to parse target state for ID '${e}': ${t}`),
                null)
          );
        }
        zs() {
      ...
      class s6 {
        ...
        static Gs(e, t) {
          ...
          for (let e = 0; r && e < n.activeTargetIds.length; ++e)
            ((r = eD(n.activeTargetIds[e])), (i = i.add(n.activeTargetIds[e])));
          return r
            ? new s6(e, i)
            : (E(s5, `Failed to parse client data for instance '${e}': ${t}`),
              null);
        }
      }
      class s8 {
        ...
        static Gs(e) {
          ...
          return "object" == typeof t &&
            ...
            ? new s8(t.clientId, t.onlineState)
            : (E(s5, `Failed to parse online state: ${e}`), null);
        }
      }
      class s9 {
        constructor() {
      ...
      class s7 {
        constructor(e, t, n, r, i) {
          ...
          ((this.storage = this.window.localStorage),
            (this.currentUser = i),
            (this.no = sJ(this.persistenceKey, this.Js)),
            (this.ro =
              ((s = this.persistenceKey), `firestore_sequence_number_${s}`)),
            (this.Xs = this.Xs.insert(this.Js, new s9())),
            (this.io = RegExp(`^${sX}_${l}_([^_]*)$`)),
            (this.so = RegExp(`^${sZ}_${l}_(\\d+)(?:_(.*))?$`)),
            (this.oo = RegExp(`^${s1}_${l}_(\\d+)$`)),
            (this._o =
        ...
        async start() {
          for (let e of await this.syncEngine.Is()) {
            if (e === this.Js) continue;
            let t = this.getItem(sJ(this.persistenceKey, e));
            if (t) {
              let n = s6.Gs(e, t);
          ...
          this.uo();
          let e = this.storage.getItem(this._o);
          if (e) {
            let t = this.co(e);
            t && this.lo(t);
          }
          for (let e of this.eo) this.Zs(e);
          ((this.eo = []),
        ...
        updateMutationState(e, t, n) {
          (this.Po(e, t, n), this.To(e));
        }
        addLocalQueryTarget(e, t = !0) {
          let n = "not-current";
          if (this.isActiveQueryTarget(e)) {
            let t = this.storage.getItem(s2(this.persistenceKey, e));
            if (t) {
              let r = s3.Gs(e, t);
              r && (n = r.state);
            }
        ...
        clearQueryState(e) {
          this.removeItem(s2(this.persistenceKey, e));
        }
        ...
        getItem(e) {
          ...
          return (T(s5, "READ", e, t), t);
        }
        setItem(e, t) {
          (T(s5, "SET", e, t), this.storage.setItem(e, t));
        }
        removeItem(e) {
          (T(s5, "REMOVE", e), this.storage.removeItem(e));
        }
        Zs(e) {
          if (e.storageArea === this.storage) {
            if ((T(s5, "EVENT", e.key, e.newValue), e.key === this.no))
              return void E(
            ...
            this.xi.enqueueRetryable(async () => {
              if (this.started) {
                if (null !== e.key) {
                  if (this.io.test(e.key)) {
                    if (null == e.newValue) {
                      let t = this.Vo(e.key);
                      return this.mo(t, null);
                    }
                    {
                      let t = this.fo(e.key, e.newValue);
                      if (t) return this.mo(t.clientId, t);
                    }
                  } else if (this.so.test(e.key)) {
                    if (null !== e.newValue) {
                      let t = this.po(e.key, e.newValue);
                      if (t) return this.yo(t);
                    }
                  } else if (this.oo.test(e.key)) {
                    if (null !== e.newValue) {
                      let t = this.wo(e.key, e.newValue);
                      if (t) return this.bo(t);
                    }
                  } else if (e.key === this._o) {
                    if (null !== e.newValue) {
                      let t = this.co(e.newValue);
                      if (t) return this.lo(t);
                    }
                  } else if (e.key === this.ro) {
                    let t = (function (e) {
                      let t = eS.le;
                      if (null != e)
                        try {
                          let n = JSON.parse(e);
                          (C("number" == typeof n, 30636, { So: e }), (t = n));
                        } catch (e) {
                          E(
                            s5,
                    ...
                    t !== eS.le && this.sequenceNumberHandler(t);
                  } else if (e.key === this.ao) {
                    let t = this.Do(e.newValue);
                    await Promise.all(t.map((e) => this.syncEngine.vo(e)));
                  }
                }
              } else this.eo.push(e);
            });
        ...
        Po(e, t, n) {
          let r = new s4(this.currentUser, e, t, n),
            i = s0(this.persistenceKey, this.currentUser, e);
          this.setItem(i, r.zs());
        }
        To(e) {
          let t = s0(this.persistenceKey, this.currentUser, e);
          this.removeItem(t);
        }
        Ao(e) {
          let t = { clientId: this.Js, onlineState: e };
          this.storage.setItem(this._o, JSON.stringify(t));
        }
        Eo(e, t, n) {
          let r = s2(this.persistenceKey, e),
            i = new s3(e, t, n);
          this.setItem(r, i.zs());
        }
        Ro(e) {
        ...
        po(e, t) {
          let n = this.so.exec(e),
            r = Number(n[1]),
            i = void 0 !== n[2] ? n[2] : null;
          return s4.Gs(new y(i), r, t);
        }
        wo(e, t) {
          let n = Number(this.oo.exec(e)[1]);
          return s3.Gs(n, t);
        }
        co(e) {
          return s8.Gs(e);
        ...
        async yo(e) {
          ...
          T(s5, `Ignoring mutation for non-active user ${e.user.uid}`);
        }
        bo(e) {
          return this.syncEngine.Fo(e.targetId, e.state, e.error);
        }
        mo(e, t) {
          let n = t ? this.Xs.insert(e, t) : this.Xs.remove(e),
            r = this.ho(this.Xs),
            i = this.ho(n),
            s = [],
            a = [];
      ...
      class ae {
        ...
        start() {
          return ((this.xo = new s9()), Promise.resolve());
        }
        handleUserChange(e, t, n) {}
        setOnlineState(e) {}
        shutdown() {}
      ...
      class ar {
        ...
        Lo() {
          for (let e of (T(an, "Network connectivity changed: AVAILABLE"),
          this.Qo))
            e(0);
        }
        qo() {
          for (let e of (T(an, "Network connectivity changed: UNAVAILABLE"),
          this.Qo))
            e(1);
        }
        static C() {
      ...
      function as() {
        return (
          null === ai
            ? (ai = 0x10000000 + Math.round(0x80000000 * Math.random()))
            : ai++,
          "0x" + ai.toString(16)
        );
      }
      let aa = "RestConnection",
        ao = {
      ...
      class al {
        ...
        constructor(e) {
          ...
          ((this.Ko = t + "://" + e.host),
            ...
            (this.Go =
              this.databaseId.database === tY
                ? `project_id=${n}`
                : `project_id=${n}&database_id=${r}`));
        }
        zo(e, t, n, r, i) {
          let s = as(),
            a = this.jo(e, t.toUriEncodedString());
          T(aa, `Sending RPC '${e}' ${s}:`, a, n);
          let o = {
          ...
          let { host: l } = new URL(a),
            u = (0, h.zJ)(l);
          return this.Jo(e, a, o, n, u).then(
            (t) => (T(aa, `Received RPC '${e}' ${s}: `, t), t),
            (t) => {
              throw (
                b(
                  aa,
        ...
        Ho(e, t, n) {
          ((e["X-Goog-Api-Client"] = "gl-js/ fire/" + w),
      ...
      class ac extends al {
                ...
                try {
                  switch (o.getLastErrorCode()) {
                    case d.O4.NO_ERROR:
                      ...
                      break;
                    case d.O4.TIMEOUT:
                      (T(ah, `RPC '${e}' ${s} timed out`),
                        a(new D(N.DEADLINE_EXCEEDED, "Request time out")));
                      break;
                    case d.O4.HTTP_ERROR:
                      ...
                      } else a(new D(N.UNAVAILABLE, "Connection failed."));
                      break;
                    default:
                      _(9055, {
                        h_: e,
                        streamId: s,
                        P_: o.getLastErrorCode(),
                        T_: o.getLastError(),
                      });
                  }
                } finally {
                  T(ah, `RPC '${e}' ${s} completed.`);
                }
              }));
            let l = JSON.stringify(r);
            (T(ah, `RPC '${e}' ${s} sending request:`, r),
        ...
        I_(e, t, n) {
          ...
          (void 0 !== u && (l.longPollingTimeout = Math.round(1e3 * u)),
            ...
            this.Ho(l.initMessageHeaders, t, n),
            (l.encodeInitMessageHeaders = !0));
          let h = s.join("");
          T(ah, `Creating RPC '${e}' stream ${i}: ${h}`, l);
            ...
            g = new au({
              Zo: (t) => {
                m
                  ...
                  : (f ||
                      (T(ah, `Opening RPC '${e}' stream ${i} transport.`),
                      c.open(),
                      (f = !0)),
                    T(ah, `RPC '${e}' stream ${i} sending:`, t),
                    c.send(t));
              },
              Xo: () => c.close(),
            }),
          ...
          return (
            p(c, d.iO.EventType.OPEN, () => {
              m || (T(ah, `RPC '${e}' stream ${i} transport opened.`), g.__());
            }),
            p(c, d.iO.EventType.CLOSE, () => {
              m ||
                ((m = !0),
                T(ah, `RPC '${e}' stream ${i} transport closed`),
                g.u_(),
                this.d_(c));
            }),
            p(c, d.iO.EventType.ERROR, (t) => {
              m ||
                ...
                g.u_(
                  new D(N.UNAVAILABLE, "The operation could not be completed"),
                ));
            }),
            p(c, d.iO.EventType.MESSAGE, (t) => {
              ...
              if (!m) {
                ...
                let a =
                  ...
                  (null == (n = s[0]) ? void 0 : n.error);
                if (a) {
                  T(ah, `RPC '${e}' stream ${i} received error:`, a);
                  let t = a.status,
                    n = (function (e) {
                      let t = r[e];
                      if (void 0 !== t) return rM(t);
                    })(t),
                    s = a.message;
                  (void 0 === n &&
                    ((n = N.INTERNAL),
                    ...
                    g.u_(new D(n, s)),
                    c.close());
                } else (T(ah, `RPC '${e}' stream ${i} received:`, s), g.c_(s));
              }
            }),
            p(o, d.Jh.STAT_EVENT, (t) => {
              t.stat === d.ro.PROXY
                ? T(ah, `RPC '${e}' stream ${i} detected buffering proxy`)
                : t.stat === d.ro.NOPROXY &&
                  T(ah, `RPC '${e}' stream ${i} detected no buffering proxy`);
            }),
            setTimeout(() => {
              g.a_();
            }, 0),
      ...
      class ag {
        ...
        y_(e) {
          this.cancel();
          let t = Math.floor(this.m_ + this.w_()),
            n = Math.max(0, Date.now() - this.g_),
            r = Math.max(0, t - n);
          (r > 0 &&
            T(
              "ExponentialBackoff",
              `Backing off for ${r} ms (base delay: ${this.m_} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`,
            ),
            (this.f_ = this.xi.enqueueAfterDelay(
              this.timerId,
              r,
              () => ((this.g_ = Date.now()), e()),
            )),
            (this.m_ *= this.R_),
            this.m_ < this.A_ && (this.m_ = this.A_),
            this.m_ > this.V_ && (this.m_ = this.V_));
        }
        b_() {
      ...
      class ay {
        ...
        k_() {
          this.N_() &&
            null === this.C_ &&
            (this.C_ = this.xi.enqueueAfterDelay(this.S_, 6e4, () =>
              this.q_(),
            ));
        }
        Q_(e) {
        ...
        z_(e, t) {
          let n = this.G_(this.v_);
          ((this.stream = this.H_(e, t)),
            this.stream.e_(() => {
              n(() => this.listener.e_());
            }),
            this.stream.n_(() => {
              ...
              if ("targetChange" in t) {
                ...
                let s =
                  ...
                  o =
                    ...
                    e.useProto3Json
                      ? (C(void 0 === i || "string" == typeof i, 58123),
                        tM.fromBase64String(i || ""))
                      : (C(
                          void 0 === i ||
                            i instanceof m ||
                        ...
                        tM.fromUint8Array(i || new Uint8Array()))),
                ...
                n = new rG(
                  ...
                  (l &&
                    new D(
                      void 0 === l.code ? N.UNKNOWN : rM(l.code),
                      l.message || "",
                    )) ||
                    null,
                );
                ...
                let i = r9(e, r.document.name),
                  s = r5(r.document.updateTime),
                  a = r.document.createTime
                    ? r5(r.document.createTime)
                    : j.min(),
                  o = new nc({ mapValue: { fields: r.document.fields } }),
                  l = nd.newFoundDocument(i, s, a, o);
                n = new r$(
                  r.targetIds || [],
                  r.removedTargetIds || [],
                  l.key,
                ...
                r.document;
                let i = r9(e, r.document),
                  s = r.readTime ? r5(r.readTime) : j.min(),
                  a = nd.newNoDocument(i, s);
                n = new r$([], r.removedTargetIds || [], a.key, a);
              } else if ("documentRemove" in t) {
                t.documentRemove;
                let r = t.documentRemove;
                r.document;
                let i = r9(e, r.document);
                n = new r$([], r.removedTargetIds || [], i, null);
              } else {
                if (!("filter" in t)) return _(11601, { Vt: t });
                {
                  t.filter;
                  let e = t.filter;
                  e.targetId;
                  let { count: r = 0, unchangedNames: i } = e,
                    s = new rR(r, i);
                  n = new rK(e.targetId, s);
                }
              }
              return n;
            })(this.serializer, e),
            n = (function (e) {
              if (!("targetChange" in e)) return j.min();
          ...
          ((t.database = it(this.serializer)),
            (t.addTarget = (function (e, t) {
              ...
              if (
                (((n = nL(r)
                  ? { documents: il(e, r) }
                  : { query: iu(e, r).gt }).targetId = t.targetId),
                t.resumeToken.approximateByteSize() > 0)
              ) {
                n.resumeToken = r2(e, t.resumeToken);
                let r = r0(e, t.expectedCount);
                null !== r && (n.expectedCount = r);
              } else if (t.snapshotVersion.compareTo(j.min()) > 0) {
                n.readTime = r1(e, t.snapshotVersion.toTimestamp());
                let r = r0(e, t.expectedCount);
                null !== r && (n.expectedCount = r);
              }
              return n;
      ...
      class av extends ay {
        ...
        J_(e) {
          return (
            C(!!e.streamToken, 31322),
            (this.lastStreamToken = e.streamToken),
            C(!e.writeResults || 0 === e.writeResults.length, 55816),
            this.listener.na()
          );
        }
        onNext(e) {
          var t, n;
          (C(!!e.streamToken, 12678),
            (this.lastStreamToken = e.streamToken),
            this.x_.reset());
          let r =
              ((t = e.writeResults),
              ...
              t && t.length > 0
                ? (C(void 0 !== n, 14353),
                  t.map((e) => {
                    let t;
                    return (
                      (t = e.updateTime ? r5(e.updateTime) : r5(n)).isEqual(
                        j.min(),
                      ) && (t = r5(n)),
                      new rp(t, e.transformResults || [])
                    );
                  }))
                : []),
            i = r5(e.commitTime);
          return this.listener.ra(i, r);
        }
        ia() {
          let e = {};
          ((e.database = it(this.serializer)), this.Q_(e));
        }
        ta(e) {
          let t = {
            streamToken: this.lastStreamToken,
            writes: e.map((e) => ia(this.serializer, e)),
          };
          this.Q_(t);
        }
      }
        ...
        zo(e, t, n, r) {
          return (
            ...
            Promise.all([
              ...
              .then(([i, s]) => this.connection.zo(e, r3(t, n), r, i, s))
              .catch((e) => {
                throw "FirebaseError" === e.name
                  ? (e.code === N.UNAUTHENTICATED &&
                      (this.authCredentials.invalidateToken(),
                      this.appCheckCredentials.invalidateToken()),
                    e)
                  : new D(N.UNKNOWN, e.toString());
              })
          );
        }
        Yo(e, t, n, r, i) {
          return (
            ...
            Promise.all([
              ...
              .then(([s, a]) => this.connection.Yo(e, r3(t, n), r, s, a, i))
              .catch((e) => {
                throw "FirebaseError" === e.name
                  ? (e.code === N.UNAUTHENTICATED &&
                      (this.authCredentials.invalidateToken(),
      ...
      class aE {
        ...
        ca() {
          0 === this._a &&
            (this.la("Unknown"),
            (this.aa = this.asyncQueue.enqueueAfterDelay(
              "online_state_timeout",
              1e4,
              () => (
                (this.aa = null),
                this.ha("Backend didn't respond within 10 seconds."),
                this.la("Offline"),
                Promise.resolve()
              ),
            )));
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
          this.ua ? (E(t), (this.ua = !1)) : T("OnlineStateTracker", t);
        }
        Ta() {
          ...
          ((this.localStore = e),
            ...
            this.Ra.No((e) => {
              n.enqueueAndForget(async () => {
                aR(this) &&
                  (T(ab, "Restarting streams for network reachability change."),
      ...
      async function a_(e) {
        if (aR(e)) for (let t of e.Aa) await t(!0);
      }
      async function aS(e) {
        for (let t of e.Aa) await t(!1);
      }
      function aC(e, t) {
        e.Ea.has(t.targetId) ||
          (e.Ea.set(t.targetId, t), aV(e) ? aA(e) : aH(e).N_() && aD(e, t));
      }
      function aN(e, t) {
        let n = aH(e);
        (e.Ea.delete(t),
          n.N_() && ak(e, t),
          0 === e.Ea.size && (n.N_() ? n.k_() : aR(e) && e.Va.set("Unknown")));
      }
      function aD(e, t) {
        if (
          (e.ma.Ke(t.targetId),
          t.resumeToken.approximateByteSize() > 0 ||
            t.snapshotVersion.compareTo(j.min()) > 0)
        ) {
      ...
      function aV(e) {
        return aR(e) && !aH(e).O_() && e.Ea.size > 0;
      }
      function aR(e) {
        return 0 === e.da.size;
      }
      ...
      async function aF(e, t) {
        ((e.ma = void 0), aV(e) ? (e.Va.Pa(t), aA(e)) : e.Va.set("Unknown"));
      }
      async function aL(e, t, n) {
        if ((e.Va.set("Online"), t instanceof rG && 2 === t.state && t.cause))
          try {
          ...
          try {
                ...
                return (
                  ...
                  n.targetMismatches.forEach((t, n) => {
                    ...
                    (e.Ea.set(
                      ...
                      ak(e, t));
                    let i = new ig(r.target, t, n, r.sequenceNumber);
                    aD(e, i);
                  }),
            ...
            (T(ab, "Failed to raise snapshot:", t), await aP(e, t));
          }
      }
      async function aP(e, t, n) {
        ...
        (e.da.add(1),
          ...
          e.asyncQueue.enqueueRetryable(async () => {
            (T(ab, "Retrying IndexedDB access"),
              await n(),
              e.da.delete(1),
              await a_(e));
          }));
      ...
      async function aq(e) {
        var t;
        let n = aW(e),
          r = e.Ia.length > 0 ? e.Ia[e.Ia.length - 1].batchId : -1;
        for (; aR((t = e)) && t.Ia.length < 10; )
          try {
      ...
      function aB(e) {
        return aR(e) && !aW(e).O_() && e.Ia.length > 0;
      }
      function az(e) {
        aW(e).start();
      }
      ...
      async function aK(e) {
        let t = aW(e);
        for (let n of e.Ia) t.ta(n.mutations);
      }
      async function aG(e, t, n) {
        let r = e.Ia.shift(),
          i = rA.from(r, t, n);
        (await aU(e, () => e.remoteSyncer.applySuccessfulWrite(i)),
          await aq(e));
      }
      ...
      async function aQ(e, t) {
        (e.asyncQueue.verifyOperationInProgress(),
          T(ab, "RemoteStore received new credentials"));
        let n = aR(e);
        (e.da.add(3),
          await aS(e),
          n && e.Va.set("Unknown"),
      ...
      async function aY(e, t) {
        t
          ? (e.da.delete(2), await a_(e))
          : t || (e.da.add(2), await aS(e), e.Va.set("Unknown"));
      }
      function aH(e) {
        var t, n, r;
        return (
          e.fa ||
            ...
            e.Aa.push(async (t) => {
              t
                ? (e.fa.L_(), aV(e) ? aA(e) : e.Va.set("Unknown"))
                : (await e.fa.stop(), (e.ma = void 0));
            })),
          e.fa
        );
      }
              ...
              t
                ...
                : (await e.ga.stop(),
                  e.Ia.length > 0 &&
                    (T(
                      ab,
                      `Stopping write stream with ${e.Ia.length} pending writes`,
                    ),
                    (e.Ia = [])));
            })),
          e.ga
      ...
      class aX {
        ...
        static createAndSchedule(e, t, n, r, i) {
          let s = new aX(e, t, Date.now() + n, r, i);
          return (s.start(n), s);
        }
        start(e) {
        ...
        cancel(e) {
          null !== this.timerHandle &&
            ...
            this.deferred.reject(
              new D(N.CANCELLED, "Operation cancelled" + (e ? ": " + e : "")),
            ));
        }
        handleDelayElapsed() {
      ...
      function aJ(e, t) {
        if ((E("AsyncQueue", `${t}: ${e}`), ew(e)))
          return new D(N.UNAVAILABLE, `${t}: ${e}`);
        throw e;
      }
      class aZ {
        static emptySet(e) {
          return new aZ(e.comparator);
        }
        constructor(e) {
          ((this.comparator = e
            ? (t, n) => e(t, n) || J.comparator(t.key, n.key)
            : (e, t) => J.comparator(e.key, t.key)),
            (this.keyedMap = n3()),
        ...
        isEqual(e) {
          if (!(e instanceof aZ) || this.size !== e.size) return !1;
        ...
        track(e) {
          ...
          n
            ? 0 !== e.type && 3 === n.type
              ...
              : 3 === e.type && 1 !== n.type
                ? (this.pa = this.pa.insert(t, { type: n.type, doc: e.doc }))
                : 2 === e.type && 2 === n.type
                  ? (this.pa = this.pa.insert(t, { type: 2, doc: e.doc }))
                  : 2 === e.type && 0 === n.type
                    ? (this.pa = this.pa.insert(t, { type: 0, doc: e.doc }))
                    : 1 === e.type && 0 === n.type
                      ? (this.pa = this.pa.remove(t))
                      : 1 === e.type && 2 === n.type
                        ? (this.pa = this.pa.insert(t, { type: 1, doc: n.doc }))
                        : 0 === e.type && 1 === n.type
                          ? (this.pa = this.pa.insert(t, {
                              type: 2,
                              doc: e.doc,
                            }))
                          : _(63341, { Vt: e, ya: n })
      ...
      class a1 {
        ...
        static fromInitialDocuments(e, t, n, r, i) {
          ...
          return (
            ...
            new a1(e, t, aZ.emptySet(t), s, n, r, !0, !1, i)
          );
        }
        get hasPendingWrites() {
      ...
      class a5 {
        ...
        terminate() {
          ...
          })(this, new D(N.ABORTED, "Firestore shutting down"));
        }
      }
      function a4() {
        return new n2((e) => nX(e), nW);
      }
      async function a3(e, t) {
        let n = 3,
          r = t.query,
          i = e.queries.get(r);
        i ? !i.Da() && t.va() && (n = 2) : ((i = new a2()), (n = +!t.va()));
        try {
          switch (n) {
            case 0:
              i.ba = await e.onListen(r, !0);
              break;
            case 1:
              i.ba = await e.onListen(r, !1);
              break;
            case 2:
              await e.onFirstRemoteStoreListen(r);
          }
        } catch (n) {
          let e = aJ(n, `Initialization of query '${nJ(t.query)}' failed`);
      ...
      async function a6(e, t) {
        let n = t.query,
          ...
          i = e.queries.get(n);
        if (i) {
          let e = i.Sa.indexOf(t);
          e >= 0 &&
            (i.Sa.splice(e, 1),
            0 === i.Sa.length ? (r = +!t.va()) : !i.Da() && t.va() && (r = 2));
        }
        switch (r) {
          case 0:
      ...
      function a9(e, t, n) {
        ...
        if (r) for (let e of r.Sa) e.onError(n);
        e.queries.delete(t);
      }
      function a7(e) {
        e.Ca.forEach((e) => {
      ...
      (((a = s || (s = {})).xa = "default"), (a.Cache = "cache"));
      class oe {
        constructor(e, t, n) {
          ((this.query = e),
            (this.Oa = t),
        ...
        Ma(e) {
          ...
          return (
            this.Na
              ? this.La(e) && (this.Oa.next(e), (t = !0))
              : this.ka(e, this.onlineState) && (this.qa(e), (t = !0)),
            (this.Ba = e),
            t
          );
        }
        ...
        ka(e, t) {
          return (
            !(e.fromCache && this.va()) ||
            ((!this.options.Qa || "Offline" === t) &&
              (!e.docs.isEmpty() || e.hasCachedResults || "Offline" === t))
          );
        }
        La(e) {
          if (e.docChanges.length > 0) return !0;
          let t = this.Ba && this.Ba.hasPendingWrites !== e.hasPendingWrites;
          return (
      ...
      class on {
        ...
        Us(e) {
          return r9(this.serializer, e);
        }
        Ks(e) {
          return e.metadata.exists
            ? is(this.serializer, e.document, !1)
            : nd.newNoDocument(
      ...
      class os {
        ...
        tu(e, t) {
              ...
              (u && h
                ? u.data.isEqual(h.data)
                  ...
                  : this.ru(u, h) ||
                    ...
                    (f = !0),
                    ((o && this.Za(h, o) > 0) || (l && 0 > this.Za(h, l))) &&
                      (a = !0))
                : !u && h
          ...
          return { Xa: s, nu: n, Cs: a, mutatedKeys: i };
        }
        ru(e, t) {
          return (
            e.hasLocalMutations &&
          ...
          (s.sort(
            (e, t) =>
              (function (e, t) {
                ...
                return n(e) - n(t);
              })(e.type, t.type) || this.Za(e.doc, t.doc),
          ),
            this.iu(n),
            (r = null != r && r));
          let a = t && !r ? this.su() : [],
            o = 0 === this.Ya.size && this.current && !r ? 1 : 0,
            l = o !== this.Ja;
          return ((this.Ja = o), 0 !== s.length || l)
            ? {
                snapshot: new a1(
                  this.query,
                  e.Xa,
        ...
        _u(e) {
          return (
            !this.Ha.has(e) &&
            !!this.Xa.has(e) &&
            !this.Xa.get(e).hasLocalMutations
          );
        }
        iu(e) {
          e &&
        ...
        su() {
          ...
          return (
            e.forEach((e) => {
              this.Ya.has(e) || t.push(new oi(e));
            }),
            this.Ya.forEach((n) => {
              e.has(n) || t.push(new or(n));
            }),
            t
          );
        }
        au(e) {
          ((this.Ha = e.$s), (this.Ya = re()));
          let t = this.tu(e.documents);
          return this.applyChanges(t, !0);
        }
        uu() {
          return a1.fromInitialDocuments(
            this.query,
            this.Xa,
            this.mutatedKeys,
            0 === this.Ja,
      ...
      class ou {
        constructor(e, t, n, r, i, s) {
          ((this.localStore = e),
            ...
            (this.lu = {}),
            (this.hu = new n2((e) => nX(e), nW)),
            (this.Pu = new Map()),
            (this.Tu = new Set()),
            (this.Iu = new tC(J.comparator)),
            (this.Eu = new Map()),
            (this.du = new sv()),
            (this.Au = {}),
            (this.Ru = new Map()),
      ...
      async function of(e, t, n, r, i) {
        e.fu = (t, n, r) =>
          (async function (e, t, n, r) {
            let i = t.view.tu(n);
            i.Cs &&
              (i = await sG(e.localStore, t.query, !1).then(
                ({ documents: e }) => t.view.tu(e, i),
              ));
            ...
            return (oS(e, t.targetId, o.ou), o.snapshot);
          })(e, t, n, r);
        let s = await sG(e.localStore, t, !0),
          a = new os(t, s.$s),
          o = a.tu(s.documents),
          l = rz.createSynthesizedTargetChangeForCurrentChange(
            n,
        ...
        e.isPrimaryClient
          ? (e.sharedClientState.removeLocalQueryTarget(r.targetId),
            e.sharedClientState.isActiveQueryTarget(r.targetId) ||
              (await sK(e.localStore, r.targetId, !1)
                .then(() => {
                  (e.sharedClientState.clearQueryState(r.targetId),
                    n && aN(e.remoteStore, r.targetId),
                    ox(e, r.targetId));
                })
                .catch(eh)))
          : (ox(e, r.targetId), await sK(e.localStore, r.targetId, !0));
      }
      async function og(e, t) {
        let n = e.hu.get(t),
          r = e.Pu.get(n.targetId);
        e.isPrimaryClient &&
          1 === r.length &&
          ...
          let e,
            s = await (function (e, t) {
              let n,
                r,
                i = G.now(),
                s = t.reduce((e, t) => e.add(t.key), re());
              return e.persistence
                .runTransaction("Locally write mutations", "readwrite", (a) => {
                  let o = n5,
                    l = re();
                  return e.Bs.getEntries(a, s)
                    .next((e) => {
                      (o = e).forEach((e, t) => {
                                ...
                                return (
                                  t_(t.fields, (t, r) => {
                                    ...
                                    if (ni(r)) {
                                      ...
                                      else for (let e of t) n.push(i.child(e));
                                    } else n.push(i);
                                  }),
                                  new tR(n)
                                );
                ...
                .then(() => ({ batchId: r.batchId, changes: n6(n) }));
            })(r.localStore, t);
          (r.sharedClientState.addPendingMutation(s.batchId),
            (i = s.batchId),
            (e = r.Au[r.currentUser.toKey()]) || (e = new tC(B)),
            (e = e.insert(i, n)),
            (r.Au[r.currentUser.toKey()] = e),
            await oN(r, s.changes),
            await aq(r.remoteStore));
        } catch (t) {
          let e = aJ(t, "Failed to persist write");
          n.reject(e);
        }
      }
          ...
          let n = await (function (e, t) {
            ...
            return e.persistence
              .runTransaction(
                ...
                "readwrite-primary",
                (i) => {
                  let s = e.Bs.newChangeBuffer({ trackRemovals: !0 });
                  r = e.xs;
                  let a = [];
                  t.targetChanges.forEach((s, o) => {
                    ...
                    if (!u) return;
                    a.push(
                      e.Ti.removeMatchingKeys(i, s.removedDocuments, o).next(
                        () => e.Ti.addMatchingKeys(i, s.addedDocuments, o),
                      ),
                    );
                    let h = u.withSequenceNumber(i.currentSequenceNumber);
                    (null !== t.targetMismatches.get(o)
                      ? (h = h
                          .withResumeToken(tM.EMPTY_BYTE_STRING, j.min())
                      ...
                      (0 === u.resumeToken.approximateByteSize() ||
                        ...
                        s.addedDocuments.size +
                          ...
                          0) &&
                        a.push(e.Ti.updateTargetData(i, h)));
                  });
                  let o = n5,
                    l = re();
                  if (
                    ...
                    a.push(
                      sz(i, s, t.documentUpdates).next((e) => {
                        ((o = e.qs), (l = e.Qs));
                      }),
                    ),
                    !n.isEqual(j.min()))
                  ) {
                    let t = e.Ti.getLastRemoteSnapshotVersion(i).next((t) =>
                      e.Ti.setTargetsMetadata(i, i.currentSequenceNumber, n),
                    );
                    a.push(t);
                  }
                  return ec
      ...
      async function ov(e, t, n) {
        ...
        let r = e.Eu.get(t),
          i = r && r.key;
        if (i) {
          let n = new tC(J.comparator);
          n = n.insert(i, nd.newNoDocument(i, j.min()));
          let r = re().add(i),
            s = new rB(j.min(), new Map(), new tC(B), n, r);
          (await oy(e, s), (e.Iu = e.Iu.remove(i)), e.Eu.delete(t), oC(e));
        } else
          await sK(e.localStore, t, !1)
            .then(() => ox(e, t, n))
            .catch(eh);
      }
      async function oI(e, t) {
        ...
        try {
          ...
          n.persistence.runTransaction(
            ...
            (e) => {
              let r = t.batch.keys(),
                i = n.Bs.newChangeBuffer({ trackRemovals: !0 });
      ...
      function ob(e, t, n) {
        ...
        if (r) {
          ...
          (i && (n ? i.reject(n) : i.resolve(), (r = r.remove(t))),
            (e.Au[e.currentUser.toKey()] = r));
        }
      }
      function ox(e, t, n = null) {
      ...
      function oS(e, t, n) {
        for (let r of n)
          r instanceof or
            ? (e.du.addReference(r.key, t),
              (function (e, t) {
                let n = t.key,
                  r = n.path.canonicalString();
                e.Iu.get(n) ||
                  e.Tu.has(r) ||
                  (T(oa, "New document in limbo: " + n), e.Tu.add(r), oC(e));
              })(e, r))
            : r instanceof oi
              ? (T(oa, "Document no longer in limbo: " + r.key),
                e.du.removeReference(r.key, t),
                e.du.containsKey(r.key) || o_(e, r.key))
              : _(19791, { pu: r });
      }
      function oC(e) {
        for (; e.Tu.size > 0 && e.Iu.size < e.maxConcurrentLimboResolutions; ) {
          let t = e.Tu.values().next().value;
          e.Tu.delete(t);
          let n = new J(H.fromString(t)),
            r = e.Vu.next();
          (e.Eu.set(r, new ol(n)),
            (e.Iu = e.Iu.insert(n, r)),
            aC(
              e.remoteStore,
              new ig(nj(nz(n.path)), r, "TargetPurposeLimboResolution", eS.le),
            ));
        }
      }
        ...
        e.hu.isEmpty() ||
              ...
              e.fu(o, t, n).then((t) => {
                ...
                if ((t || n) && e.isPrimaryClient) {
                  let r = t
                    ...
                    : null ==
                        (s =
                          null == n ? void 0 : n.targetChanges.get(o.targetId))
                      ? void 0
                      : s.current;
          ...
          await (async function (e, t) {
            try {
              ...
              if (!ew(e)) throw e;
              T(sP, "Failed to update sequence numbers: " + e);
            }
            for (let n of t) {
              let t = n.targetId;
              if (!n.fromCache) {
      ...
      async function oD(e, t) {
        if (!e.currentUser.isEqual(t)) {
          T(oa, "User change. New user:", t.toKey());
          let n = await sq(e.localStore, t);
          ((e.currentUser = t),
            e.Ru.forEach((e) => {
              e.forEach((e) => {
                e.reject(
      ...
      function ok(e, t) {
        ...
        if (n && n.cu) return re().add(n.key);
        {
          ...
          for (let t of r) {
            let r = e.hu.get(t);
            n = n.unionWith(r.view.eu);
          }
          return n;
        }
      }
      async function oA(e, t) {
        let n = await sG(e.localStore, t.query, !0),
          r = t.view.au(n);
        return (e.isPrimaryClient && oS(e, t.targetId, r.ou), r);
      }
      async function oV(e, t) {
        return sQ(e.localStore, t).then((t) => oN(e, t));
      }
          ...
          return e.persistence.runTransaction(
            ...
            (r) =>
              n
                .tr(r, t)
                .next((t) =>
                  t ? e.localDocuments.getDocuments(r, t) : ec.resolve(null),
                ),
          );
        })(e.localStore, t);
        null !== s
          ? ("pending" === n
              ? await aq(e.remoteStore)
              : "acknowledged" === n || "rejected" === n
                ? (ob(e, t, r || null),
                  oE(e, t),
                  (i = e.localStore),
                  i.mutationQueue.sr(t))
                : _(6720, "Unknown batchState", { yu: n }),
            await oN(e, s))
          : T(oa, "Cannot apply mutation batch with id: " + t);
      }
      async function oO(e, t) {
        if ((oq(e), oB(e), !0 === t && !0 !== e.mu)) {
          let t = e.sharedClientState.getAllActiveQueryTargets(),
            n = await oM(e, t.toArray());
          for (let t of ((e.mu = !0), await aY(e.remoteStore, !0), n))
            aC(e.remoteStore, t);
        } else if (!1 === t && !1 !== e.mu) {
          let t = [],
            n = Promise.resolve();
          (e.Pu.forEach((r, i) => {
            (e.sharedClientState.isLocalQueryTarget(i)
              ? t.push(i)
              : (n = n.then(() => (ox(e, i), sK(e.localStore, i, !0)))),
              aN(e.remoteStore, i));
          }),
            await n,
            await oM(e, t),
            ...
            e.du.Jr(),
            (e.Eu = new Map()),
            (e.Iu = new tC(J.comparator)),
            (e.mu = !1),
            await aY(e.remoteStore, !1));
        }
      }
      async function oM(e, t, n) {
        let r = [],
        ...
        for (let n of t) {
          let t,
            s = e.Pu.get(n);
          if (s && 0 !== s.length)
            for (let n of ((t = await s$(e.localStore, nj(s[0]))), s)) {
              let t = e.hu.get(n),
                r = await oA(e, t);
              r.snapshot && i.push(r.snapshot);
            }
          else {
            let r = await sj(e.localStore, n);
            ((t = await s$(e.localStore, r)),
              await of(e, oF(r), n, !1, t.resumeToken));
          }
          r.push(t);
        }
        return (e.lu.Y_(i), r);
      ...
      function oF(e) {
        ...
        return (
          ...
          (i = e.filters),
          (s = e.limit),
          new nB(t, n, r, i, s, "F", e.startAt, e.endAt)
        );
      }
      function oL(e) {
        return e.localStore.persistence.Is();
      }
      async function oP(e, t, n, r) {
        if (e.mu)
          return void T(oa, "Ignoring unexpected query state notification.");
        let i = e.Pu.get(t);
        if (i && i.length > 0)
          switch (n) {
            case "current":
            case "not-current": {
              let r = await sQ(e.localStore, n0(i[0])),
                s = rB.createSynthesizedRemoteEventForCurrentChange(
                  t,
                  "current" === n,
                  tM.EMPTY_BYTE_STRING,
                );
            ...
            case "rejected":
              (await sK(e.localStore, t, !0), ox(e, t, r));
              break;
            default:
              _(64155, n);
          }
        ...
        if (r.mu) {
          for (let e of t) {
            if (r.Pu.has(e) && r.sharedClientState.isActiveQueryTarget(e)) {
              T(oa, "Adding an already active target " + e);
              continue;
            }
            let t = await sj(r.localStore, e),
              n = await s$(r.localStore, t);
            (await of(r, oF(t), n.targetId, !1, n.resumeToken),
              aC(r.remoteStore, n));
          }
          for (let e of n)
            r.Pu.has(e) &&
              (await sK(r.localStore, e, !1)
                .then(() => {
                  (aN(r.remoteStore, e), ox(r, e));
                })
                .catch(eh));
        }
      }
      function oq(e) {
        return (
          (e.remoteStore.remoteSyncer.applyRemoteEvent = oy.bind(null, e)),
          (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ok.bind(
            null,
            e,
          )),
          (e.remoteStore.remoteSyncer.rejectListen = ov.bind(null, e)),
          (e.lu.Y_ = a8.bind(null, e.eventManager)),
          (e.lu.gu = a9.bind(null, e.eventManager)),
          e
        );
      }
      function oB(e) {
        return (
          (e.remoteStore.remoteSyncer.applySuccessfulWrite = oI.bind(null, e)),
          (e.remoteStore.remoteSyncer.rejectFailedWrite = oT.bind(null, e)),
          e
        );
      }
      class oz {
        ...
        async initialize(e) {
          ((this.serializer = am(e.databaseInfo.databaseId)),
            ...
            (this.persistence = this.Su(e)),
            await this.persistence.start(),
            (this.localStore = this.Du(e)),
            (this.gcScheduler = this.vu(e, this.localStore)),
            (this.indexBackfillerScheduler = this.Cu(e, this.localStore)));
        }
        vu(e, t) {
          return null;
        }
        ...
        Du(e) {
          ...
          return (
            (t = this.persistence),
            (n = new sL()),
            new sU(t, n, e.initialUser, this.serializer)
          );
        }
        Su(e) {
          return new s_(sC.fi, this.serializer);
        }
        bu(e) {
          return new ae();
        }
      ...
      class o$ extends oz {
        ...
        vu(e, t) {
          return (
            C(this.persistence.referenceDelegate instanceof sN, 46915),
            new si(
        ...
        Su(e) {
          let t =
            void 0 !== this.cacheSizeBytes
              ? i2.withCacheSize(this.cacheSizeBytes)
              : i2.DEFAULT;
          return new s_((e) => sN.fi(e, t), this.serializer);
        }
      }
      class oK extends oz {
        constructor(e, t, n) {
        ...
        async initialize(e) {
          (await super.initialize(e),
            await this.Fu.initialize(this, e),
            await oB(this.Fu.syncEngine),
            await aq(this.Fu.remoteStore),
        ...
        Cu(e, t) {
          ...
          return new ex(e.asyncQueue, n);
        }
        Su(e) {
          let t = sO(e.databaseInfo.databaseId, e.databaseInfo.persistenceKey),
            n =
              void 0 !== this.cacheSizeBytes
                ? i2.withCacheSize(this.cacheSizeBytes)
                : i2.DEFAULT;
      ...
      class oG extends oK {
        ...
        async initialize(e) {
          await super.initialize(e);
          let t = this.Fu.syncEngine;
          (this.sharedClientState instanceof s7 &&
        ...
        bu(e) {
          ...
          let n = sO(e.databaseInfo.databaseId, e.databaseInfo.persistenceKey);
          return new s7(t, e.asyncQueue, n, e.clientId, e.initialUser);
        }
      }
      class oj {
        async initialize(e, t) {
          this.localStore ||
            ...
            (this.sharedClientState.onlineStateHandler = (e) =>
              ow(this.syncEngine, e, 1)),
            (this.remoteStore.remoteSyncer.handleCredentialChange = oD.bind(
              null,
              this.syncEngine,
            )),
            await aY(this.remoteStore, this.syncEngine.isPrimaryClient));
        }
        ...
        createDatastore(e) {
          var t;
          let n = am(e.databaseInfo.databaseId),
            r = new ac(e.databaseInfo);
          return (
            (t = e.authCredentials),
            new aT(t, e.appCheckCredentials, r, n)
          );
        }
        createRemoteStore(e) {
          var t, n;
        ...
        async terminate() {
          var e, t;
          (await (async function (e) {
            (T(ab, "RemoteStore shutting down."),
              e.da.add(5),
              await aS(e),
              e.Ra.shutdown(),
              e.Va.set("Unknown"));
      ...
      class oQ {
        ...
        error(e) {
          this.muted ||
            (this.observer.error
              ? this.Mu(this.observer.error, e)
              : E("Uncaught Error in snapshot listener:", e.toString()));
        }
        xu() {
          this.muted = !0;
        }
      ...
      class oY {
        ...
        async lookup(e) {
          if ((this.ensureCommitNotCalled(), this.mutations.length > 0))
            throw (
              (this.lastTransactionError = new D(
                N.INVALID_ARGUMENT,
          ...
          let t = await (async function (e, t) {
            let n = { documents: t.map((t) => r8(e.serializer, t)) },
              r = await e.Yo(
                "BatchGetDocuments",
            ...
            r.forEach((t) => {
              ...
              let r =
                ...
                "found" in t
                  ? (function (e, t) {
                      (C(!!t.found, 43571), t.found.name, t.found.updateTime);
                      let n = r9(e, t.found.name),
                        r = r5(t.found.updateTime),
                        i = t.found.createTime
                          ? r5(t.found.createTime)
                          : j.min(),
                        s = new nc({ mapValue: { fields: t.found.fields } });
                      return nd.newFoundDocument(n, r, i, s);
                    })(n, t)
                  : "missing" in t
                    ? (function (e, t) {
                        (C(!!t.missing, 3894), C(!!t.readTime, 22933));
                        let n = r9(e, t.missing),
                          r = r5(t.readTime);
                        return nd.newNoDocument(n, r);
                      })(n, t)
                    : _(7234, { result: t }));
        ...
        delete(e) {
          (this.write(new rN(e, this.precondition(e))),
            this.writtenDocs.add(e.toString()));
        }
        async commit() {
          ...
          (this.mutations.forEach((t) => {
            ...
            e.forEach((e, t) => {
              let n = J.fromPath(t);
              this.mutations.push(new rD(n, this.precondition(n)));
            }),
            await (async function (e, t) {
              let n = { writes: t.map((t) => ia(e.serializer, t)) };
              await e.zo("Commit", e.serializer.databaseId, H.emptyPath(), n);
        ...
        recordVersion(e) {
          ...
          if (e.isFoundDocument()) t = e.version;
            ...
            if (!e.isNoDocument()) throw _(50498, { Uu: e.constructor.name });
            t = j.min();
          }
        ...
        constructor(e, t, n, r, i) {
          ((this.authCredentials = e),
            ...
            this.appCheckCredentials.start(
              n,
              (e) => (
                T(oH, "Received new app check token=", e),
          ...
          return (
            this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
              try {
                ...
                let t = aJ(n, "Failed to shutdown persistence");
                e.reject(t);
              }
            }),
            e.promise
      ...
      async function oX(e, t) {
        (e.asyncQueue.verifyOperationInProgress(),
          T(oH, "Initializing OfflineComponentProvider"));
        let n = e.configuration;
        await t.initialize(n);
        let r = n.initialUser;
        (e.setCredentialChangeListener(async (e) => {
          r.isEqual(e) || (await sq(t.localStore, e), (r = e));
        }),
      ...
      async function oJ(e, t) {
        e.asyncQueue.verifyOperationInProgress();
        let n = await oZ(e);
        (T(oH, "Initializing OnlineComponentProvider"),
          await t.initialize(n, e.configuration),
          e.setCredentialChangeListener((e) => aQ(t.remoteStore, e)),
          e.setAppCheckTokenChangeListener((e, n) => aQ(t.remoteStore, n)),
      ...
      async function oZ(e) {
        if (!e._offlineComponents)
          if (e._uninitializedComponentsProvider) {
            ...
            try {
              await oX(e, e._uninitializedComponentsProvider._offline);
            } catch (t) {
              if (
                !("FirebaseError" === t.name
                  ? t.code === N.FAILED_PRECONDITION ||
                    t.code === N.UNIMPLEMENTED
                  : !(
            ...
            (T(oH, "Using default OfflineComponentProvider"),
              await oX(e, new o$(void 0)));
        ...
        return (
          e._onlineComponents ||
            (e._uninitializedComponentsProvider
              ? (T(oH, "Using user provided OnlineComponentProvider"),
                await oJ(e, e._uninitializedComponentsProvider._online))
              : (T(oH, "Using default OnlineComponentProvider"),
                await oJ(e, new oj()))),
          e._onlineComponents
        );
      }
      async function o1(e) {
        let t = await o0(e),
          n = t.eventManager;
        return (
          (n.onListen = oh.bind(null, t.syncEngine)),
          (n.onUnlisten = om.bind(null, t.syncEngine)),
          (n.onFirstRemoteStoreListen = oc.bind(null, t.syncEngine)),
          (n.onLastRemoteStoreUnlisten = og.bind(null, t.syncEngine)),
          n
        );
      }
      function o2(e) {
      ...
      let o6 = "firestore.googleapis.com";
      class o8 {
        constructor(e) {
          var t, n;
          if (void 0 === e.host) {
            ...
            this.experimentalForceLongPolling
              ...
              : void 0 === e.experimentalAutoDetectLongPolling
                ...
                : (this.experimentalAutoDetectLongPolling =
                    !!e.experimentalAutoDetectLongPolling),
            (this.experimentalLongPollingOptions = o2(
              null != (n = e.experimentalLongPollingOptions) ? n : {},
            )),
            (function (e) {
        ...
        _terminate() {
          return (
            (function (e) {
              let t = o5.get(e);
              t &&
                (T("ComponentProvider", "Removing Datastore"),
                o5.delete(e),
                t.terminate());
            })(this),
            Promise.resolve()
      ...
      class o7 {
        ...
        withConverter(e) {
          return new o7(this.firestore, e, this._query);
        }
      }
      class le {
        constructor(e, t, n) {
      ...
      class lt extends o7 {
        constructor(e, t, n) {
          (super(e, t, nz(n)), (this._path = n), (this.type = "collection"));
        }
        get id() {
        ...
        get parent() {
          ...
          return e.isEmpty() ? null : new le(this.firestore, null, new J(e));
        }
        withConverter(e) {
      ...
      class lr {
        constructor(e = Promise.resolve()) {
          ((this.Ju = []),
            ...
            (this.tc = !1),
            (this.nc = []),
            (this.x_ = new ag(this, "async_queue_retry")),
            (this.rc = () => {
              let e = af();
              (e && T(ln, "Visibility state changed to " + e.visibilityState),
                this.x_.b_());
            }),
            (this.sc = e));
          let t = af();
          t &&
            ...
            t.addEventListener("visibilitychange", this.rc);
        }
        get isShuttingDown() {
          return this.Yu;
        }
        ...
        enterRestrictedMode(e) {
          if (!this.Yu) {
            ...
            t &&
              ...
              t.removeEventListener("visibilitychange", this.rc);
          }
        }
        enqueue(e) {
          if ((this.oc(), this.Yu)) return new Promise(() => {});
          let t = new k();
          return this._c(() =>
            this.Yu && this.tc
              ? Promise.resolve()
        ...
        async ac() {
          if (0 !== this.Ju.length) {
            try {
              ...
              if (!ew(e)) throw e;
              T(ln, "Operation failed with retryable error: " + e);
            }
            this.Ju.length > 0 && this.x_.y_(() => this.ac());
          }
        }
        _c(e) {
          let t = this.sc.then(
              ...
              e()
                .catch((e) => {
                  throw (
                    (this.Xu = e),
                    (this.ec = !1),
                    E("INTERNAL UNHANDLED ERROR: ", li(e)),
                    e
                  );
                })
                .then((e) => ((this.ec = !1), e))
        ...
        enqueueAfterDelay(e, t, n) {
          (this.oc(), this.nc.indexOf(e) > -1 && (t = 0));
          let r = aX.createAndSchedule(this, e, t, n, (e) => this.uc(e));
          return (this.Zu.push(r), r);
        }
        oc() {
          this.Xu && _(47125, { cc: li(this.Xu) });
        }
        verifyOperationInProgress() {}
        async lc() {
          let e;
          do ((e = this.sc), await e);
          while (e !== this.sc);
        }
        hc(e) {
          for (let t of this.Zu) if (t.timerId === e) return !0;
          return !1;
        }
        Pc(e) {
          return this.lc().then(() => {
            for (let t of (this.Zu.sort(
      ...
      function la(e, t) {
        let n = "object" == typeof e ? e : (0, o.Sx)(),
          r = (0, o.j6)(n, "firestore").getImmediate({
            identifier: "string" == typeof e ? e : t || tY,
          });
        if (!r._initialized) {
          let e = (0, h.yU)("firestore");
          e &&
            (function (e, t, n, r = {}) {
              var i;
              e = o3(e, o9);
              let s = (0, h.zJ)(t),
                ...
                l = `${t}:${n}`;
              (s && ((0, h.gE)(`https://${l}`), (0, h.P1)("Firestore", !0)),
                a.host !== o6 &&
                  a.host !== l &&
                  b(
              ...
              if (!(0, h.bD)(u, o) && (e._setSettings(u), r.mockUserToken)) {
                let t, n;
                if ("string" == typeof r.mockUserToken)
                  ((t = r.mockUserToken), (n = y.MOCK_USER));
                else {
                  t = (0, h.Fy)(
                    r.mockUserToken,
                ...
                e._authCredentials = new R(new A(t, n));
              }
            })(r, ...e);
        }
        return r;
      ...
      function lo(e) {
        ...
        return (e._firestoreClient || ll(e), e._firestoreClient);
      }
      function ll(e) {
        var t, n, r, i, s;
        let a = e._freezeSettings(),
          o =
            ...
            new tQ(
              ...
              o2(a.experimentalLongPollingOptions),
              a.useFetchStreams,
              a.isUsingEmulator,
            ));
      ...
      class lu {
        ...
        static fromBase64String(e) {
          try {
            return new lu(tM.fromBase64String(e));
          } catch (e) {
            throw new D(
              N.INVALID_ARGUMENT,
        ...
        static fromUint8Array(e) {
          return new lu(tM.fromUint8Array(e));
        }
        toBase64() {
      ...
      class lg {
        ...
        toMutation(e, t) {
          return null !== this.fieldMask
            ? new rx(e, this.data, this.fieldMask, t, this.fieldTransforms)
            : new rb(e, this.data, t, this.fieldTransforms);
        }
      }
      class lp {
        constructor(e, t, n) {
        ...
        toMutation(e, t) {
          return new rx(e, this.data, this.fieldMask, t, this.fieldTransforms);
        }
      }
      function ly(e) {
        switch (e) {
      ...
      class lw {
        ...
        Ac(e) {
          var t;
          let n = null == (t = this.path) ? void 0 : t.child(e),
            r = this.dc({ path: n, Rc: !1 });
          return (r.Vc(e), r);
        }
        mc(e) {
          var t;
        ...
        fc(e) {
          return this.dc({ path: void 0, Rc: !0 });
        }
        gc(e) {
          return lP(
            e,
      ...
      class lv {
        constructor(e, t, n) {
          ((this.databaseId = e),
            ...
            (this.serializer = n || am(e)));
        }
        bc(e, t, n, r = !1) {
          return new lw(
            { Ic: e, methodName: t, wc: n, path: X.emptyPath(), Rc: !1, yc: r },
            this.databaseId,
            this.serializer,
            this.ignoreUndefinedProperties,
          );
      ...
      function lT(e, t, n, r, i, s = {}) {
        let a,
          o,
          l = e.bc(s.merge || s.mergeFields ? 2 : 0, t, n, i);
        lO("Data must be an object, but it was:", l, r);
        let u = lV(r, l);
        if (s.merge) ((a = new tR(l.fieldMask)), (o = l.fieldTransforms));
      ...
      function lb(e, t, n) {
        return new lw(
          { Ic: 3, wc: t.settings.wc, methodName: e._methodName, Rc: n },
          t.databaseId,
          t.serializer,
          t.ignoreUndefinedProperties,
        );
      }
      class lx extends null {
        _toFieldTransform(e) {
          return new rg(e.path, new ro());
        }
        isEqual(e) {
      ...
      class l_ extends lc {
        ...
        _toFieldTransform(e) {
          let t = lb(this, e, !0),
            n = new rl(this.Sc.map((e) => lA(e, t)));
          return new rg(e.path, n);
        }
        isEqual(e) {
          return e instanceof l_ && (0, h.bD)(this.Sc, e.Sc);
        }
      }
      class lS extends lc {
        constructor(e, t) {
        ...
        _toFieldTransform(e) {
          let t = lb(this, e, !0),
            n = new rh(this.Sc.map((e) => lA(e, t)));
          return new rg(e.path, n);
        }
        isEqual(e) {
          return e instanceof lS && (0, h.bD)(this.Sc, e.Sc);
        }
      }
      class lC extends lc {
        constructor(e, t) {
        ...
        _toFieldTransform(e) {
          let t = new rd(e.serializer, ri(e.serializer, this.Dc));
          return new rg(e.path, t);
        }
        isEqual(e) {
          return e instanceof lC && this.Dc === e.Dc;
        }
      }
      function lN(e, t, n, r) {
        let i = e.bc(1, t, n);
        ...
        return (
          t_(r, (e, r) => {
            ...
            r = (0, h.Ku)(r);
            let l = i.mc(o);
            if (r instanceof lE) s.push(o);
            else {
              let e = lA(r, l);
              null != e && (s.push(o), a.set(o, e));
            }
          }),
          new lp(a, new tR(s), i.fieldTransforms)
        );
      }
      function lD(e, t, n, r, i, s) {
        ...
        for (let e = o.length - 1; e >= 0; --e)
          if (!lU(u, o[e])) {
            ...
            n = (0, h.Ku)(n);
            let r = a.mc(t);
            if (n instanceof lE) u.push(t);
            else {
              let e = lA(n, r);
              null != e && (u.push(t), c.set(t, e));
            }
          }
        return new lp(c, new tR(u), a.fieldTransforms);
      }
      function lk(e, t, n, r = !1) {
        return lA(n, e.bc(r ? 4 : 3, t));
      }
      function lA(e, t) {
        if (lR((e = (0, h.Ku)(e))))
          return (lO("Unsupported field value:", t, e), lV(e, t));
        if (e instanceof lc)
          return (
            (function (e, t) {
              if (!ly(t.Ic))
        ...
        return (function (e, t) {
          ...
          if (e instanceof lu)
            return { bytesValue: r2(t.serializer, e._byteString) };
          if (e instanceof le) {
            let n = t.databaseId,
          ...
          throw t.gc(`Unsupported field value: ${o4(e)}`);
        })(e, t);
      }
      function lV(e, t) {
        let n = {};
      ...
      function lO(e, t, n) {
        if (
          ...
          let r = o4(n);
          throw "an object" === r
            ? t.gc(e + " a custom object")
            : t.gc(e + " " + r);
        }
      }
      function lM(e, t, n) {
        if ((t = (0, h.Ku)(t)) instanceof lh) return t._internalPath;
        if ("string" == typeof t) return lL(e, t);
        throw lP(
      ...
      function lL(e, t, n) {
        ...
        try {
          return new lh(...t.split("."))._internalPath;
        } catch (r) {
          throw lP(
      ...
      function lP(e, t, n, r, i) {
        ...
        return (
          (s || a) &&
            ...
            a && (l += ` in document ${i}`),
            (l += ")")),
          new D(N.INVALID_ARGUMENT, o + e + l)
        );
      }
      function lU(e, t) {
      ...
      class lq {
        ...
        get(e) {
          if (this._document) {
            let t = this._document.data.field(lz("DocumentSnapshot.get", e));
      ...
      class lG extends lK {
        ...
        _apply(e) {
          ...
          return (
            l0(e._query, t),
            new o7(e.firestore, e.converter, nY(e._query, t))
          );
        }
        _parse(e) {
          let t = lI(e.firestore);
          return (function (e, t, n, r, i, s, a) {
            let o;
            if (i.isKeyField()) {
              ...
              if ("in" === s || "not-in" === s) {
                lZ(a, s);
                let t = [];
                for (let n of a) t.push(lJ(r, e, n));
                o = { arrayValue: { values: t } };
              } else o = lJ(r, e, a);
            } else
              (("in" !== s && "not-in" !== s && "array-contains-any" !== s) ||
                lZ(a, s),
                (o = lk(n, t, a, "in" === s || "not-in" === s)));
            return nw.create(i, s, o);
          })(
            e._query,
            "where",
            t,
      ...
      class lj extends l$ {
        ...
        _parse(e) {
          ...
          return 1 === t.length ? t[0] : nv.create(t, this._getOperator());
        }
        _apply(e) {
          let t = this._parse(e);
      ...
      class lY extends lK {
        ...
        _apply(e) {
          return new o7(
            e.firestore,
            e.converter,
            nH(e._query, this._limit, this._limitType),
          );
        }
      }
      class lH extends lK {
        ...
        _apply(e) {
          var t;
          let n = lX(e, this.type, this._docOrFields, this._inclusive);
          return new o7(
            e.firestore,
            e.converter,
            ((t = e._query),
      ...
      function lX(e, t, n, r) {
        if (((n[0] = (0, h.Ku)(n[0])), n[0] instanceof lq))
          return (function (e, t, n, r, i) {
            ...
            let s = [];
            for (let n of nG(e))
              if (n.field.isKeyField()) s.push(t7(t, r.key));
              else {
          ...
          return (function (e, t, n, r, i, s) {
            ...
            for (let s = 0; s < i.length; s++) {
              ...
              if (a[s].field.isKeyField()) {
                ...
                let n = e.path.child(H.fromString(l));
      ...
      function lJ(e, t, n) {
        if ("string" == typeof (n = (0, h.Ku)(n))) {
          ...
          let r = t.path.child(H.fromString(n));
        ...
        if (n instanceof le) return t7(e, n._key);
        throw new D(
          N.INVALID_ARGUMENT,
          `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${o4(n)}.`,
        );
      }
      function lZ(e, t) {
      ...
      class l1 {
        convertValue(e, t = "none") {
          switch (t2(e)) {
            ...
            case 6:
              return this.convertBytes(tU(e.bytesValue));
            case 7:
        ...
        convertVectorValue(e) {
          ...
          return new lf(
            null ==
            (r =
              null == (n = null == (t = e.fields) ? void 0 : t[t0].arrayValue)
                ? void 0
                : n.values)
              ? void 0
              : r.map((e) => tP(e.doubleValue)),
          );
        }
        convertGeoPoint(e) {
          return new ld(tP(e.latitude), tP(e.longitude));
        }
        convertArray(e, t) {
        ...
        convertServerTimestamp(e, t) {
          switch (t) {
            ...
            case "estimate":
              return this.convertTimestamp(tj(e));
            default:
              return null;
          }
        }
        ...
        convertDocumentKey(e, t) {
          let n = H.fromString(e);
          C(im(n), 9688, { name: e });
          let r = new tH(n.get(1), n.get(3)),
            i = new J(n.popFirst(5));
          return (
            r.isEqual(t) ||
              E(
      ...
      class l5 extends l1 {
        ...
        convertReference(e) {
          ...
          return new le(this.firestore, null, t);
        }
      }
      class l4 {
        constructor(e, t) {
      ...
      class l3 extends lq {
        ...
        get(e, t = {}) {
          if (this._document) {
            let n = this._document.data.field(lz("DocumentSnapshot.get", e));
            if (null !== n)
      ...
      class l9 {
        ...
        _initialize(e) {
          ((this._onlineComponentProvider = oj.provider),
      ...
      class ue {
        constructor(e, t) {
          ((this._firestore = e),
            (this._transaction = t),
            (this._dataReader = lI(e)));
        }
        get(e) {
          let t = l7(e, this._firestore),
            n = new l5(this._firestore);
          return this._transaction.lookup([t._key]).then((e) => {
            if (!e || 1 !== e.length) return _(24041);
            let r = e[0];
            if (r.isFoundDocument())
              return new lq(this._firestore, n, r.key, r, t.converter);
            if (r.isNoDocument())
              return new lq(this._firestore, n, t._key, null, t.converter);
            throw _(18433, { doc: r });
          });
        }
        set(e, t, n) {
          let r = l7(e, this._firestore),
            i = l2(r.converter, t, n),
            s = lT(
              this._dataReader,
              "Transaction.set",
              r._key,
        ...
        update(e, t, n, ...r) {
          let i,
            s = l7(e, this._firestore);
          return (
            (i =
              "string" == typeof (t = (0, h.Ku)(t)) || t instanceof lh
                ? lD(this._dataReader, "Transaction.update", s._key, t, n, r)
                : lN(this._dataReader, "Transaction.update", s._key, t)),
                ...
                (e, { instanceIdentifier: n, options: r }) => {
                  let i = e.getProvider("app").getImmediate(),
                    s = new ls(
                      ...
                      new P(i, e.getProvider("app-check-internal")),
                      (function (e, t) {
                        if (
                        ...
                        return new tH(e.options.projectId, t);
                      })(i, n),
                      i,
                    );
                  return (
