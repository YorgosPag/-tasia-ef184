...
import type { ProjectWithWorkStageSummary as Project } from '@/tasia/types/project-types';
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <Button variant="outline" size="sm" onClick={() => router.push('/projects')} className="w-fit">
