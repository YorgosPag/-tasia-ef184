...
export const companySchema = z.object({
  ...
  logoUrl: z
    .string()
    .url({ message: "Το URL του λογότυπου δεν είναι έγκυρο." })
    .or(z.literal("")),
  website: z
    .string()
    .url({ message: "Το URL του website δεν είναι έγκυρο." })
    .or(z.literal("")),
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            {editingCompany ? "Επεξεργασία" : "Προσθήκη Νέας"} Εταιρείας
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={onSubmit} className="grid gap-4 py-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                {editingCompany ? "Αποθήκευση" : "Προσθήκη"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
