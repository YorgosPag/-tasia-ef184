    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Διαχείριση παρακολουθημάτων κτιρίου {building.name}
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{stats.storage}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">{stats.parking}</div>
      ...
      {viewMode === 'list' ? (
        ...
        <Card>
          <CardHeader>
            <CardTitle>Χάρτης Αποθηκών & Πάρκινγκ</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500">Χάρτης αποθηκών και θέσεων στάθμευσης</p>
