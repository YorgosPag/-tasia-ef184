  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        title: "Σφάλμα",
        description:
          "Η υποβολή του αιτήματος απέτυχε. Παρακαλώ προσπαθήστε ξανά.",
      });
    } finally {
      ...
      <Card>
        ...
        <CardContent className="text-center">
          ...
          <p className="text-muted-foreground">
            Το αίτημά σας για το ακίνητο &quot;{unitName}&quot; έχει
            καταχωρηθεί. Ένας εκπρόσωπός μας θα επικοινωνήσει μαζί σας σύντομα.
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Συμπληρώστε τη φόρμα για να επικοινωνήσουμε μαζί σας για το ακίνητο
          &quot;{unitName}&quot;.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="π.χ. θα ήθελα να κανονίσω μια επίσκεψη..."
            />
          </div>
          {error && (
