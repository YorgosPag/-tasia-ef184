  ...
  .object({
    ...
    area: z
      ...
      .refine((val) => val === "" || !isNaN(parseFloat(val)), {
        message: "Το εμβαδόν πρέπει να είναι αριθμός.",
      })
      .optional(),
    price: z
      .string()
    ...
    photoUrl: z
      .string()
      .url({ message: "Το URL της φωτογραφίας δεν είναι έγκυρο." })
      .or(z.literal(""))
      .optional(),
    sharePercentage: z
      .string()
      ...
      .refine(
        ...
        { message: "Το ποσοστό πρέπει να είναι θετικός αριθμός." },
      )
      .optional(),
  ...
  const handleGenerateId = async () => {
    if (!unitId) {
      toast({
        variant: "destructive",
        title: "Σφάλμα",
        description: "Δεν βρέθηκε το γονικό ακίνητο.",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Σφάλμα Δημιουργίας Κωδικού",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {editingAttachment ? "Επεξεργασία" : "Νέο"} Παρακολούθημα
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div className="flex items-center gap-2">
                    <FormControl>
                      <Input {...field} placeholder="π.χ. B1D1S1" />
                    </FormControl>
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      title="Αυτόματη δημιουργία κωδικού"
                    >
                      {isGeneratingId ? (
