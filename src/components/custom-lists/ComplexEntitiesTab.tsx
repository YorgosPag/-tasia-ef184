        ...
        <CardHeader>
            <div className="flex justify-between items-center">
                 ...
                 <div className="flex gap-2">
                    <Button variant="outline" size="sm" onClick={() => handleExport('csv')} disabled={algoliaHits.length === 0}>Εξαγωγή CSV</Button>
                    <Button variant="outline" size="sm" onClick={() => handleExport('json')} disabled={algoliaHits.length === 0}>Εξαγωγή JSON</Button>
                 </div>
            </div>
            <div className="mt-4">
