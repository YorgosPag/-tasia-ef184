...
export function useWatchedFields(form: UseFormReturn<any>) {
  return {
    ...
    companyVersions: useWatch({ control: form.control, name: 'job.companyVersions' }) || [],
    docSummary: useWatch({ control: form.control, name: 'job.docSummary' }) || [],
    externalLinks: useWatch({ control: form.control, name: 'job.externalLinks' }) || [],
    registrationType: useWatch({ control: form.control, name: 'job.registrationType' }),
