  ...
  return (
    <Card className="relative border-muted">
      <CardHeader>
        ...
        <CardDescription>
          🛈 Τα στοιχεία της μετοχικής σύνθεσης θα συμπληρωθούν αυτόματα από το
          Γ.Ε.ΜΗ. μόλις ολοκληρωθεί η σύνδεση.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 opacity-50">
          <FormItem>
            <FormLabel>Τύπος Μετοχής</FormLabel>
            <FormControl>
          ...
          <FormItem>
            <FormLabel>Ονομαστική Τιμή</FormLabel>
            <FormControl>
              <Input disabled placeholder="-" />
            </FormControl>
          </FormItem>
