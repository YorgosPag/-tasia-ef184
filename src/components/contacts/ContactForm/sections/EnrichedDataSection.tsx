        ...
        <Card className="relative border-muted">
            <CardContent className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 opacity-50">
                    ...
                    <FormItem><FormLabel>Ιστοσελίδα</FormLabel><FormControl><Input disabled placeholder="—" value={form.watch('job.url') || ''} /></FormControl></FormItem>
                    <FormItem><FormLabel>Email Επιχείρησης</FormLabel><FormControl><Input disabled placeholder="—" value={form.watch('job.email') || ''} /></FormControl></FormItem>
