        ...
        <div className="space-y-4 p-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {entityType === 'Φυσικό Πρόσωπο' && (
                    <>
                        <FormField control={form.control} name="identity.type" render={({ field }) => (<FormItem className="flex items-center gap-4"><FormLabel className="w-40 text-right">Τύπος</FormLabel><div className="flex-1"><FormControl><Input placeholder="π.χ. Ταυτότητα, Διαβατήριο, Άδεια Οδήγησης" {...field} /></FormControl><FormMessage /></div></FormItem>)} />
