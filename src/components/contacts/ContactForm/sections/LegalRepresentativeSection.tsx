...
export function LegalRepresentativeSection({
  form,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="π.χ. Ιωάννης Παπαδόπουλος" />
                  </FormControl>
                </FormItem>
                <FormItem>
                  <FormLabel>Ιδιότητα</FormLabel>
                  <FormControl>
                    <Input placeholder="π.χ. Διαχειριστής" />
                  </FormControl>
                </FormItem>
                <FormItem>
                  <FormLabel>ΑΦΜ Εκπροσώπου</FormLabel>
                  <FormControl>
                    <Input placeholder="9 ψηφία" />
                  </FormControl>
                </FormItem>
              </div>
              <div className="space-y-4">
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="π.χ. ΔΟΥ Καλαμαριάς" />
                  </FormControl>
                </FormItem>
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="email"
                      placeholder="π.χ. representative@email.com"
                    />
                  </FormControl>
                </FormItem>
                <FormItem>
