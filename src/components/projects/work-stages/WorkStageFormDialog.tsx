  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>
            {editingWorkStage && "id" in editingWorkStage
              ? "Επεξεργασία"
              : "Νέο"}{" "}
            {isSubstage ? "Υποστάδιο Εργασίας" : "Στάδιο Εργασίας"}
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form
            onSubmit={onSubmit}
            className="grid max-h-[80vh] gap-4 overflow-y-auto py-4 pr-4"
          >
            <FormField
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Καθυστερεί">Καθυστερεί</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Προϋπολογισμένο Κόστος (€)</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Πραγματικό Κόστος (€)</FormLabel>
                    <FormControl>
                      <Input type="number" {...field} />
                    </FormControl>
                    <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Αφορά (IDs κτιρίων/ορόφων/ακινήτων με κόμμα)
                  </FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="π.χ. ID κτιρίου, ID ακινήτου..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="π.χ. ID σταδίου, ID υποσταδίου..."
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="π.χ. Σχέδια, Άδεια Δόμησης..."
                      rows={3}
                    />
                  </FormControl>
                  <FormDescription>
                    Καταχωρήστε ένα όνομα εγγράφου ανά γραμμή.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          ...
                          >
                            {field.value ? (
                              format(field.value, "P", { locale: el })
                            ) : (
                              <span>Επιλογή</span>
                            )}
