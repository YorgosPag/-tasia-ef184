  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>
            {editingBuilding ? "Επεξεργασία" : "Προσθήκη Νέου"} Κτιρίου
          </DialogTitle>
          <DialogDescription>
        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Κωδικός Κτιρίου</FormLabel>
                  <FormControl>
                    <Input placeholder="π.χ. Α, Β, W1" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Tags (με κόμμα)</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                {editingBuilding ? "Αποθήκευση" : "Προσθήκη"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
