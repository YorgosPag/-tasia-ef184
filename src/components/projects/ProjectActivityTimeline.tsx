...
export function ProjectActivityTimeline({ projectId }: { projectId: string }) {
  ...
  const getActionVariant = (action: string) => {
    if (action.startsWith("CREATE") || action.startsWith("DUPLICATE"))
      return "default";
    if (action.startsWith("UPDATE") || action.startsWith("UPLOAD"))
      return "secondary";
      ...
      <CardContent>
        ...
        {isLoading ? (
          ...
          <p className="text-center text-destructive py-8">
            Σφάλμα κατά τη φόρτωση του ιστορικού.
          </p>
          ...
          <p className="text-center text-muted-foreground py-8">
            {searchQuery
              ...
              : "Δεν υπάρχουν εγγραφές στο ιστορικό για αυτό το έργο."}
          </p>
        )}
      </CardContent>
    </Card>
