...
import { AddMiscellaneousDocumentDialog } from '../add-miscellaneous-document-dialog';
import { EditMiscellaneousDocumentDialog } from '../edit-miscellaneous-document-dialog';
    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription className="pt-4">
          Είστε βέβαιοι ότι θέλετε να διαγράψετε το επιλεγμένο έγγραφο; Η ενέργεια αυτή δεν μπορεί να αναιρεθεί.
...
interface MiscellaneousDocumentsToolbarProps {
...
export function MiscellaneousDocumentsToolbar({ 
  selectedDocument, 
  hasActiveFilters, 
  onClearFilters, 
  totalCount, 
...
}: MiscellaneousDocumentsToolbarProps) {
  ...
  return (
    <div className="p-1.5 border-b flex items-center gap-1 shrink-0">
      <AddMiscellaneousDocumentDialog trigger={
          <ToolbarButton tooltip="Νέο Έγγραφο" className="text-green-600 hover:text-green-700 dark:text-green-500 dark:hover:text-green-400">
              <Plus className="w-4 h-4" />
            </ToolbarButton>
        } />
      <EditMiscellaneousDocumentDialog document={selectedDocument!} trigger={
      ...
      <DeleteConfirmationDialog onConfirm={() => console.log('Delete document', selectedDocument?.id)}>
